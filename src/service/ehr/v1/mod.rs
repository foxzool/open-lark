    ...
    pub async fn get_employee(&self, _employee_id: &str) -> SDKResult<EmployeeResponse> {
        ...
        Ok(EmployeeResponse {
            ...
            data: Some(Employee {
                ...
                avatar_api_path: Some("https://example.com/avatar.jpg".to_string()),
            ...
            data: Some(Salary {
                ...
                allowances: Some(vec![
                    Allowance {
                        ...
                        name: "交通补贴".to_string(),
                        amount: 500.0,
                        calculation_http_http_method: Some("固定金额".to_string()),
                    },
                    Allowance {
                ...
                deductions: Some(vec![
                    Deduction {
                        ...
                        amount: 1500.0,
                        calculation_http_http_method: Some("按比例计算".to_string()),
                    },
                    Deduction {
