...
impl MdmService {
    ...
    pub fn validate_mdm_config(&self) -> Result<(), String> {
        // 检查国家地区服务配置
    ...
    /// # 返回值
    /// 包含服务统计信息的字典
    pub fn get_mdm_statistics(&self) -> std::collections::HashMap<String, String> {
...
mod tests {
    ...
    fn test_mdm_service_with_custom_config() {
        let config = Config::builder()
            .app_id("custom_mdm_app")
            .app_secret("custom_mdm_secret")
