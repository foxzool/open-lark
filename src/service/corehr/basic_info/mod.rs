...
impl BasicInfoService {
    ...
    pub async fn search_enum(
        ...
        let api_req = ApiRequest {
            ...
            api_path: "/open-apis/corehr/v1/basic_info/enum/search".to_string(),
    ...
    pub async fn search_country_region(
        ...
        let api_req = ApiRequest {
            http_method: Method::POST,
            api_path: "/open-apis/corehr/v1/basic_info/location_data/search".to_string(),
            supported_access_token_types: vec![AccessTokenType::Tenant],
            body: serde_json::to_vec(&request).unwrap_or_default(),
            ..Default::default()
        };
    ...
    pub async fn search_nationality(
        ...
        let api_req = ApiRequest {
            http_method: Method::POST,
            api_path: "/open-apis/corehr/v1/basic_info/nationality/search".to_string(),
            supported_access_token_types: vec![AccessTokenType::Tenant],
            body: serde_json::to_vec(&request).unwrap_or_default(),
            ..Default::default()
        };
    ...
    pub async fn convert_id(
        ...
        let api_req = ApiRequest {
            http_method: Method::POST,
            api_path: "/open-apis/corehr/v1/common_data_id/convert".to_string(),
            supported_access_token_types: vec![AccessTokenType::Tenant],
            body: serde_json::to_vec(&request).unwrap_or_default(),
            ..Default::default()
        };
