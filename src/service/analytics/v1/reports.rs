...
impl ReportService {
    ...
    pub async fn get_report_data(
        ...
        Ok(GetReportDataResponse {
            ...
            report_data: self.generate_report_data(request.report_id.as_str(), &request.parameters),
