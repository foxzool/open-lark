...
impl SheetProtectionRangeBuilder {
    ...
    /// 构建保护范围对象
    pub fn build(self) -> crate::core::error::SDKResult<SheetProtectionRange> {
        // 验证范围参数
...
impl SheetProtectionConditionBuilder {
    ...
    /// 构建保护条件对象
    pub fn build(self) -> crate::core::error::SDKResult<SheetProtectionCondition> {
...
impl UpdateSheetProtectionRequestBuilder {
    ...
    /// 构建更新请求
    pub fn build(self) -> crate::core::error::SDKResult<UpdateSheetProtectionRequest> {
...
impl DeleteSheetProtectionRequestBuilder {
    ...
    /// 构建删除请求
    pub fn build(self) -> crate::core::error::SDKResult<DeleteSheetProtectionRequest> {
        match (self.spreadsheet_token, self.sheet_id, self.protection_id) {
            (Some(spreadsheet_token), Some(sheet_id), Some(protection_id)) => {
...
impl SheetProtectionService {
    ...
    ) -> crate::core::error::SDKResult<BaseResponse<QuerySheetProtectionResponse>> {
        let mut url = format!(
    ...
    ) -> crate::core::error::SDKResult<BaseResponse<UpdateSheetProtectionResponse>> {
        let url = format!(
            "{}/open-apis/sheets/v3/spreadsheets/{}/sheets/{}/protections/{}",
            self.config.base_url,
            request.spreadsheet_token.as_str(),
    ...
    ) -> crate::core::error::SDKResult<BaseResponse<DeleteSheetProtectionResponse>> {
        let url = format!(
            "{}/open-apis/sheets/v3/spreadsheets/{}/sheets/{}/protections/{}",
            self.config.base_url,
            request.spreadsheet_token.as_str(),
