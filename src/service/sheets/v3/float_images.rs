...
impl QueryFloatImagesRequestBuilder {
    ...
    /// 构建查询浮动图片请求对象
    pub fn build(self) -> crate::core::error::SDKResult<QueryFloatImagesRequest> {
...
impl FloatImagesService {
    ...
    ) -> crate::core::error::SDKResult<BaseResponse<CreateFloatImageResponse>> {
        let url = format!(
    ...
    ) -> crate::core::error::SDKResult<BaseResponse<UpdateFloatImageResponse>> {
        let url = format!(
            "{}/open-apis/sheets/v3/spreadsheets/{}/sheets/{}/float_images/{}",
            self.config.base_url,
            request.spreadsheet_token.as_str(),
    ...
    ) -> crate::core::error::SDKResult<BaseResponse<QueryFloatImagesResponse>> {
        let mut url = format!(
    ...
    ) -> crate::core::error::SDKResult<BaseResponse<DeleteFloatImageResponse>> {
        let url = format!(
            "{}/open-apis/sheets/v3/spreadsheets/{}/sheets/{}/float_images/{}",
            self.config.base_url,
            request.spreadsheet_token.as_str(),
...
impl<'a> FloatImagesServiceBuilder<'a> {
    ...
    /// 执行操作
    pub async fn execute(self) -> crate::core::error::SDKResult<serde_json::Value> {
