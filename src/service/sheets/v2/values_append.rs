...
impl ValuesAppendRequestBuilder {
    ...
    /// 构建数据追加请求对象
    pub fn build(self) -> crate::core::error::SDKResult<ValuesAppendRequest> {
        // 验证必需参数
...
impl ValuesAppendService {
    ...
    ) -> crate::core::error::SDKResult<BaseResponse<ValuesAppendResponse>> {
        let url = format!(
...
impl<'a> ValuesAppendServiceBuilder<'a> {
    ...
    /// 执行追加操作
    pub async fn execute(self) -> crate::core::error::SDKResult<ValuesAppendResponse> {
