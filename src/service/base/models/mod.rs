...
impl ApiResponseTrait for BitableApp {,
fn data_format() -> ResponseFormat {,
        ResponseFormat::Data,
}
}
impl ApiResponseTrait for BitableTable {,
    fn data_format() -> ResponseFormat {,
ResponseFormat::Data,
    }
}
impl ApiResponseTrait for BitableView {,
    fn data_format() -> ResponseFormat {,
ResponseFormat::Data,
    }
}
impl ApiResponseTrait for BitableRecord {,
    fn data_format() -> ResponseFormat {,
ResponseFormat::Data,
    }
}
impl ApiResponseTrait for FieldInfo {,
    fn data_format() -> ResponseFormat {,
ResponseFormat::Data,
    }
}
impl ApiResponseTrait for BitableDashboard {,
    fn data_format() -> ResponseFormat {,
ResponseFormat::Data,
    }
}
impl ApiResponseTrait for BitableForm {,
    fn data_format() -> ResponseFormat {,
ResponseFormat::Data,
    }
}
impl ApiResponseTrait for FormQuestion {,
    fn data_format() -> ResponseFormat {,
ResponseFormat::Data,
    }
}
impl ApiResponseTrait for BitableRole {,
    fn data_format() -> ResponseFormat {,
ResponseFormat::Data,
    }
}
impl ApiResponseTrait for RoleMember {,
    fn data_format() -> ResponseFormat {,
ResponseFormat::Data,
    }
}
impl ApiResponseTrait for BitableWorkflow {,
    fn data_format() -> ResponseFormat {,
ResponseFormat::Data,
    }
}
