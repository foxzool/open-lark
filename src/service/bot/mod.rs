...
mod tests {
    ...
    fn create_test_config() -> Config {
        Config::builder()
            .app_id("test_bot_app_id")
            .app_secret("test_bot_app_secret")
            .build()
    }
    ...
    fn test_bot_service_enterprise_scenarios() {
        let enterprise_config = Config::builder()
            .app_id("enterprise_bot_app_id")
            .app_secret("enterprise_bot_app_secret")
            .build();
