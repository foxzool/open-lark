...
impl std::fmt::Debug for ELearningService {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        f.debug_struct("ELearningService")
            ...
            .field("course_registration_service", &"CourseRegistrationService")
            .finish()
    }
}
...
mod tests {
    ...
    fn test_elearning_service_with_custom_config() {
        let config = Config::builder()
            .app_id("custom_elearning_app")
            .app_secret("custom_elearning_secret")
    ...
    fn test_elearning_service_config_independence() {
        let config1 = Config::builder()
            .app_id("elearning_app_1")
            .app_secret("secret_1")
            .build();
        let config2 = Config::builder()
            .app_id("elearning_app_2")
            .app_secret("secret_2")
            .build();
