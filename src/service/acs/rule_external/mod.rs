...
mod tests {
    ...
    fn test_endpoint_configuration() {
        ...
        assert!(!Endpoints::ACS_V1_RULE_EXTERNAL.is_empty());
        assert!(!Endpoints::ACS_V1_RULE_EXTERNAL_OPERATION.is_empty());
        assert!(!Endpoints::ACS_V1_RULE_EXTERNAL_DEVICE_BIND.is_empty());
    }
