...
impl Service for TaskService {
    fn config(&self) -> &Config {
        ...
        DEFAULT_CONFIG.get_or_init(|| {
            Config::builder()
                .app_id("task_service_default")
                .app_secret("task_service_secret")
                .build()
        })
    }
...
mod tests {
    ...
    fn create_test_config() -> Config {
        Config::builder()
            .app_id("test_task_app_id")
            .app_secret("test_task_app_secret")
            .build()
    }
    ...
    fn test_task_service_enterprise_scenarios() {
        let enterprise_config = Config::builder()
            .app_id("enterprise_task_app_id")
            .app_secret("enterprise_task_app_secret")
            .build();
