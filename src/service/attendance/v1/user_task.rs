...
impl UserTaskService {
    ...
    pub async fn batch_create(
        ...
        // 构建请求体
        let body = json!({
            "user_tasks": request.user_tasks.clone()
        });
    ...
    pub async fn get(
        ...
        api_req
            .query_params
            .insert("check_date".to_string(), request.check_date.clone());
    ...
    pub async fn query(
        ...
        if let Some(check_date_from) = &request.check_date_from {
            api_req
                .query_params
                .insert("check_date_from".to_string(), check_date_from.clone());
        }

        if let Some(check_date_to) = &request.check_date_to {
            api_req
                .query_params
                .insert("check_date_to".to_string(), check_date_to.clone());
        }
