...
//! 4. 统一架构 - 合并多个端点文件为单一权威源
//!
//! # 文件历史
//!
//! 本文件由以下文件合并而成：
//! - `endpoints_original.rs` - 主要实现源
//! - `endpoints_clean.rs` - 空占位符文件
//! - `endpoints_new.rs` - 部分重写尝试
//!
//! # 性能优化
//!
//! 使用静态字符串常量可以显著减少内存分配：
...
impl Endpoints {
    ...
    /// 获取云文档元数据
    pub const SUITE_DOCS_META: &'static str = "/open-apis/suite/docs-api/meta";
