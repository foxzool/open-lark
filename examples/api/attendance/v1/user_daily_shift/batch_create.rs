...
use open_lark::{
    prelude::LarkClient,
    service::attendance::v1::models::{BatchCreateUserDailyShiftRequest, UserDailyShift},
};
use std::env;
...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    // 构建创建排班表请求
    let mut req = BatchCreateUserDailyShiftRequest::default();
    ...
    println!("排班信息数量: {}", req.user_daily_shifts.len());
