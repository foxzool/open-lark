...
mod tests {
    ...
    async fn test_modern_message_service_api() {
        ...
        let _service = ModernMessageService { config };

        let _body = CreateMessageRequestBody {
...
///
/// ```rust,no_run
/// use open_lark::core::request_executor::RequestExecutor;
///
/// let executor = RequestExecutor::new();
/// let result = executor.get("https://api.example.com/data").await?;
/// ```
#[allow(dead_code)]
fn main() {
    println!("RequestExecutor 示例代码");
}
