...
impl TestRuntime {
    ...
    pub fn new() -> Self {
        Self {
            rt: Runtime::new().expect("Failed to create test runtime. This may indicate insufficient system resources."),
        }
    }
...
pub fn test_runtime() -> Runtime {
    Runtime::new().expect("Failed to create test runtime. This may indicate insufficient system resources.")
}
