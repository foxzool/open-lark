//! 查询一次性支付授予记录
//!
//! docPath: https://open.feishu.cn/document/server-docs/compensation-v1/lump_sum_payment/query
...
impl QueryRequest {
    ...
    pub async fn execute_with_options(
        ...
        let api_endpoint = CompensationApiV1::LumpSumPaymentQuery;
