//! 批量获取员工参保档案
//!
//! docPath: https://open.feishu.cn/document/server-docs/compensation-v1/social_archive/query
...
impl QueryRequest {
    ...
    pub async fn execute_with_options(
        ...
        let api_endpoint = CompensationApiV1::SocialArchiveQuery;
