...
impl AdditionalInformation {
    ...
    pub async fn post_open_apis_performance_v2_additional_informations_query(&self, payload: Option<&Value>) -> SDKResult<Value> {
    ...
    pub async fn post_open_apis_performance_v2_additional_informations_import(&self, payload: Option<&Value>) -> SDKResult<Value> {
