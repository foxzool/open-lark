...
impl StageTask {
    ...
    pub async fn post_open_apis_performance_v1_stage_tasks_find_by_user_list(&self, payload: Option<&Value>) -> SDKResult<Value> {
    ...
    pub async fn post_open_apis_performance_v1_stage_tasks_find_by_page(&self, payload: Option<&Value>) -> SDKResult<Value> {
