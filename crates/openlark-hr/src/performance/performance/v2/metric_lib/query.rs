//! 获取指标库列表
//!
//! docPath: https://open.feishu.cn/document/server-docs/performance-v2/metric_lib/query
...
impl QueryRequest {
    ...
    pub async fn execute_with_options(
        ...
        // 1. 构建端点
        let api_endpoint = PerformanceApiV1::MetricLibQuery;
