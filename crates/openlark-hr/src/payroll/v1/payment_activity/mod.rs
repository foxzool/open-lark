...
impl PaymentActivity {
    ...
    pub async fn post_open_apis_payroll_v1_payment_activitys_archive(&self, payload: Option<&Value>) -> SDKResult<Value> {
    ...
    pub async fn get_open_apis_payroll_v1_payment_activitys(&self, payload: Option<&Value>) -> SDKResult<Value> {
