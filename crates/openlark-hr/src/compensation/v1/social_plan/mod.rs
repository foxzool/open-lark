...
impl SocialPlan {
    ...
    pub async fn post_open_apis_compensation_v1_social_plans_query(&self, payload: Option<&Value>) -> SDKResult<Value> {
    ...
    pub async fn get_open_apis_compensation_v1_social_plans(&self, payload: Option<&Value>) -> SDKResult<Value> {
