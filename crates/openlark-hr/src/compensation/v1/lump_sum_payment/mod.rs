...
impl LumpSumPayment {
    ...
    pub async fn post_open_apis_compensation_v1_lump_sum_payment_batch_create(&self, payload: Option<&Value>) -> SDKResult<Value> {
    ...
    pub async fn post_open_apis_compensation_v1_lump_sum_payment_batch_update(&self, payload: Option<&Value>) -> SDKResult<Value> {
    ...
    pub async fn post_open_apis_compensation_v1_lump_sum_payment_query(&self, payload: Option<&Value>) -> SDKResult<Value> {
    ...
    pub async fn post_open_apis_compensation_v1_lump_sum_payment_query_detail(&self, payload: Option<&Value>) -> SDKResult<Value> {
    ...
    pub async fn post_open_apis_compensation_v1_lump_sum_payment_batch_remove(&self, payload: Option<&Value>) -> SDKResult<Value> {
