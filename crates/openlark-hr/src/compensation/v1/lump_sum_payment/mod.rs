...
impl LumpSumPayment {
    ...
    pub async fn post_open_apis_compensation_v1_lump_sum_payment_batch_create(
        ...
        let path = "/open-apis/compensation/v1/lump_sum_payment/batch_create".to_string();
    ...
    pub async fn post_open_apis_compensation_v1_lump_sum_payment_batch_update(
        ...
        let path = "/open-apis/compensation/v1/lump_sum_payment/batch_update".to_string();
        let method = Method::POST;
        let (query, body) = match method {
            Method::GET | Method::DELETE => (payload, None),
            _ => (None, payload),
    ...
    pub async fn post_open_apis_compensation_v1_lump_sum_payment_query(
        ...
        let path = "/open-apis/compensation/v1/lump_sum_payment/query".to_string();
        let method = Method::POST;
        let (query, body) = match method {
            Method::GET | Method::DELETE => (payload, None),
            _ => (None, payload),
    ...
    pub async fn post_open_apis_compensation_v1_lump_sum_payment_query_detail(
        ...
        let path = "/open-apis/compensation/v1/lump_sum_payment/query_detail".to_string();
        let method = Method::POST;
        let (query, body) = match method {
            Method::GET | Method::DELETE => (payload, None),
            _ => (None, payload),
    ...
    pub async fn post_open_apis_compensation_v1_lump_sum_payment_batch_remove(
        ...
        let path = "/open-apis/compensation/v1/lump_sum_payment/batch_remove".to_string();
        let method = Method::POST;
        let (query, body) = match method {
            Method::GET | Method::DELETE => (payload, None),
            _ => (None, payload),
