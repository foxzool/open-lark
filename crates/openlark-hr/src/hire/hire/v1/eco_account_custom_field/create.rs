...
use crate::hire::hire::common_models::EcoCustomFieldSummary;
...
impl CreateRequest {
    ...
    pub async fn execute_with_options(
        ...
        let mut request =
            ApiRequest::<CreateResponse>::post("/open-apis/hire/v1/eco_account_custom_fields");
...
pub struct CreateResponse {
    ...
    /// `custom_field` 字段。
    pub custom_field: Option<EcoCustomFieldSummary>,
