//! 获取面试评价详细信息
//!
//! docPath: https://open.feishu.cn/document/server-docs/hire-v1/interview_record/get
...
impl GetRequest {
    ...
    pub async fn execute_with_options(
        ...
        validate_required!(self.interview_record_id.trim(), "面试记录 ID 不能为空");

        let api_endpoint = HireApiV1::InterviewRecordGet(self.interview_record_id.clone());
