//! 删除三方协议
//!
//! docPath: https://open.feishu.cn/document/server-docs/hire-v1/tripartite_agreement/delete
...
impl DeleteRequest {
    ...
    pub async fn execute_with_options(
        ...
        let api_endpoint = HireApiV1::TripartiteAgreementDelete(self.agreement_id);
