...
use crate::hire::hire::common_models::EcoBackgroundCheckPackageSummary;
...
impl CreateRequest {
    ...
    pub async fn execute_with_options(
        ...
        let mut request =
            ApiRequest::<CreateResponse>::post("/open-apis/hire/v1/eco_background_check_packages");
...
pub struct CreateResponse {
    ...
    pub package: Option<EcoBackgroundCheckPackageSummary>,
