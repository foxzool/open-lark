//! 创建外部投递
//!
//! docPath: https://open.feishu.cn/document/server-docs/hire-v1/external_application/create
...
impl CreateRequest {
    ...
    pub async fn execute_with_options(
        ...
        let mut request =
            ApiRequest::<CreateResponse>::post("/open-apis/hire/v1/external_applications");
