//! 获取招聘官网列表
//!
//! docPath: https://open.feishu.cn/document/server-docs/hire-v1/website/list
...
impl ListRequest {
    ...
    pub async fn execute_with_options(
        ...
        let mut request = ApiRequest::<ListResponse>::get("/open-apis/hire/v1/websites");
        ...
        response.data.ok_or_else(|| {
            error::validation_error("获取招聘官网列表响应数据为空", "服务器没有返回有效的数据")
        })
    }
}
