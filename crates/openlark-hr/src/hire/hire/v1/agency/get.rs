//! 获取猎头供应商信息
//!
//! docPath: https://open.feishu.cn/document/server-docs/hire-v1/agency/get
...
use crate::hire::hire::common_models::AgencySummary;
...
impl GetRequest {
    ...
    pub async fn execute_with_options(
        ...
        let api_endpoint = HireApiV1::AgencyGet(self.agency_id);
