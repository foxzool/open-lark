...
impl Offer {
    ...
    pub async fn put_open_apis_hire_v1_offers_by_offer_id(&self, offer_id: impl AsRef<str>, payload: Option<&Value>) -> SDKResult<Value> {
    ...
    pub async fn get_open_apis_hire_v1_offers_by_offer_id(&self, offer_id: impl AsRef<str>, payload: Option<&Value>) -> SDKResult<Value> {
        let mut path = "/open-apis/hire/v1/offers/:offer_id".to_string();
        path = path.replace(":offer_id", offer_id.as_ref());
    ...
    pub async fn patch_open_apis_hire_v1_offers_by_offer_id_offer_status(&self, offer_id: impl AsRef<str>, payload: Option<&Value>) -> SDKResult<Value> {
    ...
    pub async fn post_open_apis_hire_v1_offers_by_offer_id_intern_offer_status(&self, offer_id: impl AsRef<str>, payload: Option<&Value>) -> SDKResult<Value> {
