...
impl ExamMarkingTask {
    ...
    pub async fn get_open_apis_hire_v1_exam_marking_tasks(&self, payload: Option<&Value>) -> SDKResult<Value> {
        let mut path = "/open-apis/hire/v1/exam_marking_tasks".to_string();
