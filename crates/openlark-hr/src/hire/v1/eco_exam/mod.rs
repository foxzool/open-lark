...
impl EcoExam {
    ...
    pub async fn post_open_apis_hire_v1_eco_exams_by_exam_id_login_info(&self, exam_id: impl AsRef<str>, payload: Option<&Value>) -> SDKResult<Value> {
    ...
    pub async fn post_open_apis_hire_v1_eco_exams_by_exam_id_update_result(&self, exam_id: impl AsRef<str>, payload: Option<&Value>) -> SDKResult<Value> {
