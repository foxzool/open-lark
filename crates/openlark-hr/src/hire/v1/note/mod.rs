...
impl Note {
    ...
    pub async fn patch_open_apis_hire_v1_notes_by_note_id(&self, note_id: impl AsRef<str>, payload: Option<&Value>) -> SDKResult<Value> {
    ...
    pub async fn get_open_apis_hire_v1_notes_by_note_id(&self, note_id: impl AsRef<str>, payload: Option<&Value>) -> SDKResult<Value> {
        let mut path = "/open-apis/hire/v1/notes/:note_id".to_string();
        path = path.replace(":note_id", note_id.as_ref());
    ...
    pub async fn delete_open_apis_hire_v1_notes_by_note_id(&self, note_id: impl AsRef<str>, payload: Option<&Value>) -> SDKResult<Value> {
        let mut path = "/open-apis/hire/v1/notes/:note_id".to_string();
        path = path.replace(":note_id", note_id.as_ref());
