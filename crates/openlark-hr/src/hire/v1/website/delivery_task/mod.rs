...
impl WebsiteDeliveryTask {
    ...
    pub async fn get_open_apis_hire_v1_websites_by_website_id_delivery_tasks_by_delivery_task_id(
        &self,
        website_id: impl AsRef<str>,
        delivery_task_id: impl AsRef<str>,
        payload: Option<&Value>,
    ) -> SDKResult<Value> {
        let mut path =
            "/open-apis/hire/v1/websites/:website_id/delivery_tasks/:delivery_task_id".to_string();
