...
impl WebsiteJobPost {
    ...
    pub async fn get_open_apis_hire_v1_websites_by_website_id_job_posts_by_job_post_id(
        &self,
    ...
    pub async fn post_open_apis_hire_v1_websites_by_website_id_job_posts_search(
        &self,
        website_id: impl AsRef<str>,
        payload: Option<&Value>,
    ) -> SDKResult<Value> {
    ...
    pub async fn get_open_apis_hire_v1_websites_by_website_id_job_posts(
        &self,
        website_id: impl AsRef<str>,
        payload: Option<&Value>,
    ) -> SDKResult<Value> {
