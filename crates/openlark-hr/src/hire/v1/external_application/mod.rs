...
impl ExternalApplication {
    ...
    pub async fn post_open_apis_hire_v1_external_applications(&self, payload: Option<&Value>) -> SDKResult<Value> {
    ...
    pub async fn put_open_apis_hire_v1_external_applications_by_external_application_id(&self, external_application_id: impl AsRef<str>, payload: Option<&Value>) -> SDKResult<Value> {
        let mut path = "/open-apis/hire/v1/external_applications/:external_application_id".to_string();
    ...
    pub async fn get_open_apis_hire_v1_external_applications(&self, payload: Option<&Value>) -> SDKResult<Value> {
        let mut path = "/open-apis/hire/v1/external_applications".to_string();
    ...
    pub async fn delete_open_apis_hire_v1_external_applications_by_external_application_id(&self, external_application_id: impl AsRef<str>, payload: Option<&Value>) -> SDKResult<Value> {
        let mut path = "/open-apis/hire/v1/external_applications/:external_application_id".to_string();
        path = path.replace(":external_application_id", external_application_id.as_ref());
