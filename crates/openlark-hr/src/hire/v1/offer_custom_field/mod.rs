...
impl OfferCustomField {
    ...
    pub async fn put_open_apis_hire_v1_offer_custom_fields_by_offer_custom_field_id(&self, offer_custom_field_id: impl AsRef<str>, payload: Option<&Value>) -> SDKResult<Value> {
