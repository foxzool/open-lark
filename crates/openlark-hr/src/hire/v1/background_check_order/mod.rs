...
impl BackgroundCheckOrder {
    ...
    pub async fn get_open_apis_hire_v1_background_check_orders(&self, payload: Option<&Value>) -> SDKResult<Value> {
    ...
    pub async fn post_open_apis_hire_v1_background_check_orders_batch_query(&self, payload: Option<&Value>) -> SDKResult<Value> {
