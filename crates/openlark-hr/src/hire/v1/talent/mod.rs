...
impl Talent {
    ...
    pub async fn post_open_apis_hire_talents_by_talent_id_tag(
        &self,
    ...
    pub async fn post_open_apis_hire_v1_talents_combined_create(
        &self,
        payload: Option<&Value>,
    ) -> SDKResult<Value> {
    ...
    pub async fn post_open_apis_hire_v1_talents_combined_update(
        &self,
        payload: Option<&Value>,
    ) -> SDKResult<Value> {
    ...
    pub async fn post_open_apis_hire_v1_talents_add_to_folder(
        &self,
        payload: Option<&Value>,
    ) -> SDKResult<Value> {
    ...
    pub async fn post_open_apis_hire_v1_talents_remove_to_folder(
        &self,
        payload: Option<&Value>,
    ) -> SDKResult<Value> {
    ...
    pub async fn post_open_apis_hire_v1_talents_batch_get_id(
        &self,
        payload: Option<&Value>,
    ) -> SDKResult<Value> {
    ...
    pub async fn get_open_apis_hire_v1_talents_by_talent_id(
        &self,
        talent_id: impl AsRef<str>,
        payload: Option<&Value>,
    ) -> SDKResult<Value> {
    ...
    pub async fn post_open_apis_hire_v1_talents_by_talent_id_onboard_status(
        &self,
        talent_id: impl AsRef<str>,
        payload: Option<&Value>,
    ) -> SDKResult<Value> {
