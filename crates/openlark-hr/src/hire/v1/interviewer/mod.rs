...
impl Interviewer {
    ...
    pub async fn get_open_apis_hire_v1_interviewers(
        &self,
        payload: Option<&Value>,
    ) -> SDKResult<Value> {
        let path = "/open-apis/hire/v1/interviewers".to_string();
    ...
    pub async fn patch_open_apis_hire_v1_interviewers_by_interviewer_id(
        &self,
        interviewer_id: impl AsRef<str>,
        payload: Option<&Value>,
    ) -> SDKResult<Value> {
