...
impl ExternalInterviewAssessment {
    ...
    pub async fn post_open_apis_hire_v1_external_interview_assessments(
        &self,
        payload: Option<&Value>,
    ) -> SDKResult<Value> {
        let path = "/open-apis/hire/v1/external_interview_assessments".to_string();
    ...
    pub async fn patch_open_apis_hire_v1_external_interview_assessments_by_external_interview_assessment_id(
        &self,
        external_interview_assessment_id: impl AsRef<str>,
        payload: Option<&Value>,
    ) -> SDKResult<Value> {
        let mut path =
        ...
        path = path.replace(
            ...
            external_interview_assessment_id.as_ref(),
        );
