...
impl TripartiteAgreement {
    ...
    pub async fn post_open_apis_hire_v1_tripartite_agreements(
        &self,
        payload: Option<&Value>,
    ) -> SDKResult<Value> {
        let path = "/open-apis/hire/v1/tripartite_agreements".to_string();
    ...
    pub async fn get_open_apis_hire_v1_tripartite_agreements(
        &self,
        payload: Option<&Value>,
    ) -> SDKResult<Value> {
        let path = "/open-apis/hire/v1/tripartite_agreements".to_string();
    ...
    pub async fn put_open_apis_hire_v1_tripartite_agreements_by_tripartite_agreement_id(
        &self,
        tripartite_agreement_id: impl AsRef<str>,
        payload: Option<&Value>,
    ) -> SDKResult<Value> {
        let mut path =
            "/open-apis/hire/v1/tripartite_agreements/:tripartite_agreement_id".to_string();
    ...
    pub async fn delete_open_apis_hire_v1_tripartite_agreements_by_tripartite_agreement_id(
        &self,
        tripartite_agreement_id: impl AsRef<str>,
        payload: Option<&Value>,
    ) -> SDKResult<Value> {
