...
impl Employee {
    ...
    pub async fn patch_open_apis_hire_v1_employees_by_employee_id(
        &self,
    ...
    pub async fn get_open_apis_hire_v1_employees_get_by_application(
        &self,
        payload: Option<&Value>,
    ) -> SDKResult<Value> {
    ...
    pub async fn get_open_apis_hire_v1_employees_by_employee_id(
        &self,
        employee_id: impl AsRef<str>,
        payload: Option<&Value>,
    ) -> SDKResult<Value> {
