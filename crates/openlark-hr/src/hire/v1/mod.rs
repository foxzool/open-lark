...
impl HireV1 {
    ...
    pub fn eco_background_check_custom_field(
        &self,
    ...
    pub fn eco_background_check_package(
        &self,
    ...
    pub fn external_interview_assessment(
        &self,
    ...
    pub fn interview_record_attachment(
        &self,
    ) -> interview_record::attachment::InterviewRecordAttachment {
        interview_record::attachment::InterviewRecordAttachment::new(self.service.clone())
    }

    pub fn interview_registration_schema(
        &self,
