...
impl ReferralWebsiteJobPost {
    ...
    pub async fn get_open_apis_hire_v1_referral_websites_job_posts(&self, payload: Option<&Value>) -> SDKResult<Value> {
        let mut path = "/open-apis/hire/v1/referral_websites/job_posts".to_string();
    ...
    pub async fn get_open_apis_hire_v1_referral_websites_job_posts_by_job_post_id(&self, job_post_id: impl AsRef<str>, payload: Option<&Value>) -> SDKResult<Value> {
