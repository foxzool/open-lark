...
impl ExternalInterview {
    ...
    pub async fn post_open_apis_hire_v1_external_interviews(&self, payload: Option<&Value>) -> SDKResult<Value> {
    ...
    pub async fn put_open_apis_hire_v1_external_interviews_by_external_interview_id(&self, external_interview_id: impl AsRef<str>, payload: Option<&Value>) -> SDKResult<Value> {
    ...
    pub async fn post_open_apis_hire_v1_external_interviews_batch_query(&self, payload: Option<&Value>) -> SDKResult<Value> {
    ...
    pub async fn delete_open_apis_hire_v1_external_interviews_by_external_interview_id(&self, external_interview_id: impl AsRef<str>, payload: Option<&Value>) -> SDKResult<Value> {
        let mut path = "/open-apis/hire/v1/external_interviews/:external_interview_id".to_string();
        path = path.replace(":external_interview_id", external_interview_id.as_ref());
