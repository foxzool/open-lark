...
impl Job {
    ...
    pub async fn post_open_apis_hire_v1_jobs_combined_create(&self, payload: Option<&Value>) -> SDKResult<Value> {
    ...
    pub async fn post_open_apis_hire_v1_jobs_by_job_id_combined_update(&self, job_id: impl AsRef<str>, payload: Option<&Value>) -> SDKResult<Value> {
    ...
    pub async fn post_open_apis_hire_v1_jobs_by_job_id_update_config(&self, job_id: impl AsRef<str>, payload: Option<&Value>) -> SDKResult<Value> {
    ...
    pub async fn get_open_apis_hire_v1_jobs_by_job_id_get_detail(&self, job_id: impl AsRef<str>, payload: Option<&Value>) -> SDKResult<Value> {
    ...
    pub async fn get_open_apis_hire_v1_jobs_by_job_id(&self, job_id: impl AsRef<str>, payload: Option<&Value>) -> SDKResult<Value> {
    ...
    pub async fn get_open_apis_hire_v1_jobs_by_job_id_recruiter(&self, job_id: impl AsRef<str>, payload: Option<&Value>) -> SDKResult<Value> {
    ...
    pub async fn get_open_apis_hire_v1_jobs_by_job_id_config(&self, job_id: impl AsRef<str>, payload: Option<&Value>) -> SDKResult<Value> {
    ...
    pub async fn post_open_apis_hire_v1_jobs_by_job_id_close(&self, job_id: impl AsRef<str>, payload: Option<&Value>) -> SDKResult<Value> {
    ...
    pub async fn post_open_apis_hire_v1_jobs_by_job_id_open(&self, job_id: impl AsRef<str>, payload: Option<&Value>) -> SDKResult<Value> {
