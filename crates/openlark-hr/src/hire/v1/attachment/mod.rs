...
impl Attachment {
    ...
    pub async fn post_open_apis_hire_v1_attachments(
        &self,
        payload: Option<&Value>,
    ) -> SDKResult<Value> {
        let path = "/open-apis/hire/v1/attachments".to_string();
    ...
    pub async fn get_open_apis_hire_v1_attachments_by_attachment_id(
        &self,
    ...
    pub async fn get_open_apis_hire_v1_attachments_by_attachment_id_preview(
        &self,
        attachment_id: impl AsRef<str>,
        payload: Option<&Value>,
    ) -> SDKResult<Value> {
