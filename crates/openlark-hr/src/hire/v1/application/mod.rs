...
impl Application {
    ...
    pub async fn get_open_apis_hire_v1_applications_by_application_id_get_detail(&self, application_id: impl AsRef<str>, payload: Option<&Value>) -> SDKResult<Value> {
    ...
    pub async fn post_open_apis_hire_v1_applications_by_application_id_recover(&self, application_id: impl AsRef<str>, payload: Option<&Value>) -> SDKResult<Value> {
    ...
    pub async fn post_open_apis_hire_v1_applications(&self, payload: Option<&Value>) -> SDKResult<Value> {
    ...
    pub async fn post_open_apis_hire_v1_applications_by_application_id_terminate(&self, application_id: impl AsRef<str>, payload: Option<&Value>) -> SDKResult<Value> {
    ...
    pub async fn post_open_apis_hire_v1_applications_by_application_id_transfer_stage(&self, application_id: impl AsRef<str>, payload: Option<&Value>) -> SDKResult<Value> {
    ...
    pub async fn get_open_apis_hire_v1_applications_by_application_id(&self, application_id: impl AsRef<str>, payload: Option<&Value>) -> SDKResult<Value> {
    ...
    pub async fn get_open_apis_hire_v1_applications(&self, payload: Option<&Value>) -> SDKResult<Value> {
        let mut path = "/open-apis/hire/v1/applications".to_string();
        let method = Method::GET;
        let (query, body) = match method {
            Method::GET | Method::DELETE => (payload, None),
    ...
    pub async fn get_open_apis_hire_v1_applications_by_application_id_offer(&self, application_id: impl AsRef<str>, payload: Option<&Value>) -> SDKResult<Value> {
    ...
    pub async fn post_open_apis_hire_v1_applications_by_application_id_transfer_onboard(&self, application_id: impl AsRef<str>, payload: Option<&Value>) -> SDKResult<Value> {
        let mut path = "/open-apis/hire/v1/applications/:application_id/transfer_onboard".to_string();
        path = path.replace(":application_id", application_id.as_ref());
        let method = Method::POST;
        let (query, body) = match method {
            Method::GET | Method::DELETE => (payload, None),
    ...
    pub async fn post_open_apis_hire_v1_applications_by_application_id_cancel_onboard(&self, application_id: impl AsRef<str>, payload: Option<&Value>) -> SDKResult<Value> {
