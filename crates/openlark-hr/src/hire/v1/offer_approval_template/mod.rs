...
impl OfferApprovalTemplate {
    ...
    pub async fn get_open_apis_hire_v1_offer_approval_templates(&self, payload: Option<&Value>) -> SDKResult<Value> {
        let mut path = "/open-apis/hire/v1/offer_approval_templates".to_string();
