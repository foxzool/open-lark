...
impl Referral {
    ...
    pub async fn post_open_apis_hire_v1_referrals_search(&self, payload: Option<&Value>) -> SDKResult<Value> {
    ...
    pub async fn get_open_apis_hire_v1_referrals_get_by_application(&self, payload: Option<&Value>) -> SDKResult<Value> {
