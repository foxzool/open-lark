...
impl ExternalOffer {
    ...
    pub async fn post_open_apis_hire_v1_external_offers(&self, payload: Option<&Value>) -> SDKResult<Value> {
        let mut path = "/open-apis/hire/v1/external_offers".to_string();
    ...
    pub async fn put_open_apis_hire_v1_external_offers_by_external_offer_id(&self, external_offer_id: impl AsRef<str>, payload: Option<&Value>) -> SDKResult<Value> {
    ...
    pub async fn post_open_apis_hire_v1_external_offers_batch_query(&self, payload: Option<&Value>) -> SDKResult<Value> {
        let mut path = "/open-apis/hire/v1/external_offers/batch_query".to_string();
        let method = Method::POST;
        let (query, body) = match method {
            Method::GET | Method::DELETE => (payload, None),
            _ => (None, payload),
    ...
    pub async fn delete_open_apis_hire_v1_external_offers_by_external_offer_id(&self, external_offer_id: impl AsRef<str>, payload: Option<&Value>) -> SDKResult<Value> {
        let mut path = "/open-apis/hire/v1/external_offers/:external_offer_id".to_string();
        path = path.replace(":external_offer_id", external_offer_id.as_ref());
