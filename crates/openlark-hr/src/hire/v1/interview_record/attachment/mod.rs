...
impl InterviewRecordAttachment {
    ...
    pub async fn get_open_apis_hire_v1_interview_records_attachments(&self, payload: Option<&Value>) -> SDKResult<Value> {
        let mut path = "/open-apis/hire/v1/interview_records/attachments".to_string();
