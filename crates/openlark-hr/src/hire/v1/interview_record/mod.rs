...
impl InterviewRecord {
    ...
    pub async fn get_open_apis_hire_v1_interview_records_by_interview_record_id(&self, interview_record_id: impl AsRef<str>, payload: Option<&Value>) -> SDKResult<Value> {
    ...
    pub async fn get_open_apis_hire_v1_interview_records(&self, payload: Option<&Value>) -> SDKResult<Value> {
