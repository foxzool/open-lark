...
impl Advertisement {
    ...
    pub async fn post_open_apis_hire_v1_advertisements_by_advertisement_id_publish(&self, advertisement_id: impl AsRef<str>, payload: Option<&Value>) -> SDKResult<Value> {
