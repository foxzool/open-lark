...
impl ProgressRecord {
    ...
    pub async fn post_open_apis_okr_v1_progress_records(
        &self,
        payload: Option<&Value>,
    ) -> SDKResult<Value> {
        let path = "/open-apis/okr/v1/progress_records".to_string();
    ...
    pub async fn delete_open_apis_okr_v1_progress_records_by_progress_id(
        &self,
        progress_id: impl AsRef<str>,
        payload: Option<&Value>,
    ) -> SDKResult<Value> {
    ...
    pub async fn put_open_apis_okr_v1_progress_records_by_progress_id(
        &self,
        progress_id: impl AsRef<str>,
        payload: Option<&Value>,
    ) -> SDKResult<Value> {
    ...
    pub async fn get_open_apis_okr_v1_progress_records_by_progress_id(
        &self,
        progress_id: impl AsRef<str>,
        payload: Option<&Value>,
    ) -> SDKResult<Value> {
