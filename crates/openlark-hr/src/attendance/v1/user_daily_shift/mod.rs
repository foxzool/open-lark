...
impl UserDailyShift {
    ...
    pub async fn post_open_apis_attendance_v1_user_daily_shifts_batch_create(&self, payload: Option<&Value>) -> SDKResult<Value> {
    ...
    pub async fn post_open_apis_attendance_v1_user_daily_shifts_query(&self, payload: Option<&Value>) -> SDKResult<Value> {
    ...
    pub async fn post_open_apis_attendance_v1_user_daily_shifts_batch_create_temp(&self, payload: Option<&Value>) -> SDKResult<Value> {
