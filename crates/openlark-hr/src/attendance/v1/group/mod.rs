...
impl Group {
    ...
    pub async fn get_open_apis_attendance_v1_groups_by_group_id_list_user(
        &self,
    ...
    pub async fn post_open_apis_attendance_v1_groups(
        &self,
        payload: Option<&Value>,
    ) -> SDKResult<Value> {
    ...
    pub async fn delete_open_apis_attendance_v1_groups_by_group_id(
        &self,
        group_id: impl AsRef<str>,
        payload: Option<&Value>,
    ) -> SDKResult<Value> {
    ...
    pub async fn get_open_apis_attendance_v1_groups_by_group_id(
        &self,
        group_id: impl AsRef<str>,
        payload: Option<&Value>,
    ) -> SDKResult<Value> {
    ...
    pub async fn post_open_apis_attendance_v1_groups_search(
        &self,
        payload: Option<&Value>,
    ) -> SDKResult<Value> {
    ...
    pub async fn get_open_apis_attendance_v1_groups(
        &self,
        payload: Option<&Value>,
    ) -> SDKResult<Value> {
        let mut path = "/open-apis/attendance/v1/groups".to_string();
