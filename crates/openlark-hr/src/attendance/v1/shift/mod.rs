...
impl Shift {
    ...
    pub async fn post_open_apis_attendance_v1_shifts(&self, payload: Option<&Value>) -> SDKResult<Value> {
    ...
    pub async fn delete_open_apis_attendance_v1_shifts_by_shift_id(&self, shift_id: impl AsRef<str>, payload: Option<&Value>) -> SDKResult<Value> {
    ...
    pub async fn get_open_apis_attendance_v1_shifts_by_shift_id(&self, shift_id: impl AsRef<str>, payload: Option<&Value>) -> SDKResult<Value> {
        let mut path = "/open-apis/attendance/v1/shifts/:shift_id".to_string();
        path = path.replace(":shift_id", shift_id.as_ref());
    ...
    pub async fn post_open_apis_attendance_v1_shifts_query(&self, payload: Option<&Value>) -> SDKResult<Value> {
    ...
    pub async fn get_open_apis_attendance_v1_shifts(&self, payload: Option<&Value>) -> SDKResult<Value> {
        let mut path = "/open-apis/attendance/v1/shifts".to_string();
        let method = Method::GET;
        let (query, body) = match method {
            Method::GET | Method::DELETE => (payload, None),
