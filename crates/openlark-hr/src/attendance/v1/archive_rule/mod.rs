...
impl ArchiveRule {
    ...
    pub async fn post_open_apis_attendance_v1_archive_rule_user_stats_fields_query(
        &self,
    ...
    pub async fn post_open_apis_attendance_v1_archive_rule_upload_report(
        &self,
        payload: Option<&Value>,
    ) -> SDKResult<Value> {
    ...
    pub async fn post_open_apis_attendance_v1_archive_rule_del_report(
        &self,
        payload: Option<&Value>,
    ) -> SDKResult<Value> {
    ...
    pub async fn get_open_apis_attendance_v1_archive_rule(
        &self,
        payload: Option<&Value>,
    ) -> SDKResult<Value> {
