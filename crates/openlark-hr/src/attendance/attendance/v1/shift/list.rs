...
use super::models::ListShiftResponse;
...
impl ListShiftRequest {
    ...
    /// 执行请求
    pub async fn execute(self) -> SDKResult<ListShiftResponse> {
...
impl ApiResponseTrait for ListShiftResponse {
