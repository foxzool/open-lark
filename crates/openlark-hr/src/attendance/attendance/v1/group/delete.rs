...
mod tests {
    ...
    #[test]
    fn test_delete_group_request_builder_new() {
        let request =
            DeleteGroupRequest::new(TestConfigBuilder::new().build()).group_id("test".to_string());
        let _ = request;
    }

    #[test]
    fn test_delete_group_request_validation_fails_on_default_request() {
        let request = DeleteGroupRequest::new(TestConfigBuilder::new().build());
