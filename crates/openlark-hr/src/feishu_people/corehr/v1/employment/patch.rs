//! 更新雇佣信息
//!
//! docPath: https://open.feishu.cn/document/server-docs/corehr-v1/employment/patch
...
impl PatchRequest {
    ...
    pub async fn execute_with_options(
        ...
        // 2. 构建端点
        let api_endpoint = FeishuPeopleApiV1::EmploymentPatch(self.employment_id.clone());
