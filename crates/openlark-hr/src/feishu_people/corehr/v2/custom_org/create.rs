//! 创建自定义组织
//!
//! docPath: https://open.feishu.cn/document/server-docs/corehr-v2/custom_org/create
...
impl CreateRequest {
    ...
    pub async fn execute_with_options(
        ...
        let mut request = ApiRequest::<CreateResponse>::post("/open-apis/corehr/v2/custom_orgs");
