//! 创建兼职
//!
//! docPath: https://open.feishu.cn/document/server-docs/corehr-v2/employees.additional_job/create
...
impl CreateRequest {
    ...
    pub async fn execute_with_options(
        ...
        let api_endpoint = FeishuPeopleApiV2::EmployeesAdditionalJobCreate;
