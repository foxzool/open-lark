//! 查询当前生效信息发生变更的地点
//!
//! docPath: https://open.feishu.cn/document/server-docs/corehr-v2/location/query_recent_change
...
impl QueryRecentChangeRequest {
    ...
    pub async fn execute_with_options(
        ...
        let mut request = ApiRequest::<QueryRecentChangeResponse>::post("/open-apis/corehr/v2/locations/query_recent_change");
