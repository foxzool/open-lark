//! 创建职等
//!
//! docPath: https://open.feishu.cn/document/server-docs/corehr-v2/job_grade/create
...
impl CreateRequest {
    ...
    pub async fn execute_with_options(
        ...
        let mut request = ApiRequest::<CreateResponse>::post("/open-apis/corehr/v2/job_grades");
