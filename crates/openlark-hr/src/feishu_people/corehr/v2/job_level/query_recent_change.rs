//! 查询当前生效信息发生变更的职级
//!
//! docPath: https://open.feishu.cn/document/server-docs/corehr-v2/job_level/query_recent_change
...
impl QueryRecentChangeRequest {
    ...
    pub async fn execute_with_options(
        ...
        let mut request = ApiRequest::<QueryRecentChangeResponse>::post("/open-apis/corehr/v2/job_levels/query_recent_change");
