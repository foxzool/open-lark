//! 查询省份/主要行政区信息
//!
//! docPath: https://open.feishu.cn/document/server-docs/corehr-v2/basic_info.country_region_subdivision/search
...
impl SearchRequest {
    ...
    pub async fn execute_with_options(
        ...
        let api_endpoint = CorehrApiV2::BasicInfoCountryRegionSubdivisionSearch;
...
pub struct SearchResponse {
    ...
    pub items: Option<Vec<CountryRegionSubdivisionItem>>,
    /// 分页令牌
    #[serde(skip_serializing_if = "Option::is_none")]
...
/// 省份/主要行政区条目信息
#[derive(Debug, Clone, Serialize, Deserialize, PartialEq)]
pub struct CountryRegionSubdivisionItem {
    /// 省份/主要行政区 ID
    #[serde(skip_serializing_if = "Option::is_none")]
