...
impl Department {
    ...
    pub async fn post_open_apis_corehr_departments_query_operation_logs(
        &self,
    ...
    pub async fn patch_open_apis_corehr_v2_departments_by_department_id(
        &self,
    ...
    pub async fn post_open_apis_corehr_v2_departments_parents(
        &self,
        payload: Option<&Value>,
    ) -> SDKResult<Value> {
    ...
    pub async fn post_open_apis_corehr_v2_departments_batch_get(
        &self,
        payload: Option<&Value>,
    ) -> SDKResult<Value> {
    ...
    pub async fn get_open_apis_corehr_v2_departments_query_recent_change(
        &self,
        payload: Option<&Value>,
    ) -> SDKResult<Value> {
    ...
    pub async fn post_open_apis_corehr_v2_departments_query_timeline(
        &self,
        payload: Option<&Value>,
    ) -> SDKResult<Value> {
    ...
    pub async fn post_open_apis_corehr_v2_departments_tree(
        &self,
        payload: Option<&Value>,
    ) -> SDKResult<Value> {
    ...
    pub async fn post_open_apis_corehr_v2_departments_query_multi_timeline(
        &self,
        payload: Option<&Value>,
    ) -> SDKResult<Value> {
    ...
    pub async fn post_open_apis_corehr_v2_departments_search(
        &self,
        payload: Option<&Value>,
    ) -> SDKResult<Value> {
    ...
    pub async fn delete_open_apis_corehr_v2_departments_by_department_id(
        &self,
        department_id: impl AsRef<str>,
        payload: Option<&Value>,
    ) -> SDKResult<Value> {
