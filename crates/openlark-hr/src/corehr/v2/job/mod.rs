...
impl Job {
    ...
    pub async fn get_open_apis_corehr_v2_jobs_by_job_id(&self, job_id: impl AsRef<str>, payload: Option<&Value>) -> SDKResult<Value> {
    ...
    pub async fn post_open_apis_corehr_v2_jobs_batch_get(&self, payload: Option<&Value>) -> SDKResult<Value> {
    ...
    pub async fn post_open_apis_corehr_v2_jobs_query_multi_timeline(&self, payload: Option<&Value>) -> SDKResult<Value> {
    ...
    pub async fn get_open_apis_corehr_v2_jobs_query_recent_change(&self, payload: Option<&Value>) -> SDKResult<Value> {
