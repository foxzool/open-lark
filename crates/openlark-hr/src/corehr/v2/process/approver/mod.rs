...
impl ProcessApprover {
    ...
    pub async fn put_open_apis_corehr_v2_processes_by_process_id_approvers_by_approver_id(
        &self,
        process_id: impl AsRef<str>,
        approver_id: impl AsRef<str>,
        payload: Option<&Value>,
    ) -> SDKResult<Value> {
        let mut path =
            "/open-apis/corehr/v2/processes/:process_id/approvers/:approver_id".to_string();
