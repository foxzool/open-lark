...
impl Process {
    ...
    pub async fn get_open_apis_corehr_v2_processes(
        &self,
    ...
    pub async fn get_open_apis_corehr_v2_processes_by_process_id(
        &self,
    ...
    pub async fn get_open_apis_corehr_v2_processes_by_process_id_flow_variable_data(
        &self,
        process_id: impl AsRef<str>,
        payload: Option<&Value>,
    ) -> SDKResult<Value> {
