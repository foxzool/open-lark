...
impl Position {
    ...
    pub async fn post_open_apis_corehr_v2_positions(
        &self,
    ...
    pub async fn patch_open_apis_corehr_v2_positions_by_position_id(
        &self,
        position_id: impl AsRef<str>,
        payload: Option<&Value>,
    ) -> SDKResult<Value> {
    ...
    pub async fn post_open_apis_corehr_v2_positions_query(
        &self,
        payload: Option<&Value>,
    ) -> SDKResult<Value> {
    ...
    pub async fn get_open_apis_corehr_v2_positions_query_recent_change(
        &self,
        payload: Option<&Value>,
    ) -> SDKResult<Value> {
    ...
    pub async fn post_open_apis_corehr_v2_positions_active(
        &self,
        payload: Option<&Value>,
    ) -> SDKResult<Value> {
    ...
    pub async fn post_open_apis_corehr_v2_positions_del_position(
        &self,
        payload: Option<&Value>,
    ) -> SDKResult<Value> {
