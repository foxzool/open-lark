...
impl CostAllocation {
    ...
    pub async fn post_open_apis_corehr_v2_cost_allocations_update_version(
        ...
        let path = "/open-apis/corehr/v2/cost_allocations/update_version".to_string();
    ...
    pub async fn post_open_apis_corehr_v2_cost_allocations_remove_version(
        ...
        let path = "/open-apis/corehr/v2/cost_allocations/remove_version".to_string();
        let method = Method::POST;
        let (query, body) = match method {
            Method::GET | Method::DELETE => (payload, None),
            _ => (None, payload),
    ...
    pub async fn post_open_apis_corehr_v2_cost_allocations_create_version(
        ...
        let path = "/open-apis/corehr/v2/cost_allocations/create_version".to_string();
        let method = Method::POST;
        let (query, body) = match method {
            Method::GET | Method::DELETE => (payload, None),
            _ => (None, payload),
    ...
    pub async fn post_open_apis_corehr_v2_cost_allocations_batch_query(
        ...
        let path = "/open-apis/corehr/v2/cost_allocations/batch_query".to_string();
        let method = Method::POST;
        let (query, body) = match method {
            Method::GET | Method::DELETE => (payload, None),
            _ => (None, payload),
