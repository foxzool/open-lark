...
impl CostAllocation {
    ...
    pub async fn post_open_apis_corehr_v2_cost_allocations_update_version(&self, payload: Option<&Value>) -> SDKResult<Value> {
    ...
    pub async fn post_open_apis_corehr_v2_cost_allocations_remove_version(&self, payload: Option<&Value>) -> SDKResult<Value> {
    ...
    pub async fn post_open_apis_corehr_v2_cost_allocations_create_version(&self, payload: Option<&Value>) -> SDKResult<Value> {
    ...
    pub async fn post_open_apis_corehr_v2_cost_allocations_batch_query(&self, payload: Option<&Value>) -> SDKResult<Value> {
