...
impl Location {
    ...
    pub async fn patch_open_apis_corehr_v2_locations_by_location_id(&self, location_id: impl AsRef<str>, payload: Option<&Value>) -> SDKResult<Value> {
    ...
    pub async fn get_open_apis_corehr_v2_locations_query_recent_change(&self, payload: Option<&Value>) -> SDKResult<Value> {
    ...
    pub async fn post_open_apis_corehr_v2_locations_batch_get(&self, payload: Option<&Value>) -> SDKResult<Value> {
    ...
    pub async fn post_open_apis_corehr_v2_locations_active(&self, payload: Option<&Value>) -> SDKResult<Value> {
