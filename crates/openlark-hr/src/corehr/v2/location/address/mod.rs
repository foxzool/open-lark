...
impl LocationAddress {
    ...
    pub async fn delete_open_apis_corehr_v2_locations_by_location_id_addresses_by_address_id(
        &self,
        location_id: impl AsRef<str>,
        address_id: impl AsRef<str>,
        payload: Option<&Value>,
    ) -> SDKResult<Value> {
        let mut path =
            "/open-apis/corehr/v2/locations/:location_id/addresses/:address_id".to_string();
    ...
    pub async fn patch_open_apis_corehr_v2_locations_by_location_id_addresses_by_address_id(
        &self,
        location_id: impl AsRef<str>,
        address_id: impl AsRef<str>,
        payload: Option<&Value>,
    ...
    pub async fn post_open_apis_corehr_v2_locations_by_location_id_addresses(
        &self,
        location_id: impl AsRef<str>,
        payload: Option<&Value>,
    ) -> SDKResult<Value> {
