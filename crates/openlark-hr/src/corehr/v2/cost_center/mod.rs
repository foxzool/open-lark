...
impl CostCenter {
    ...
    pub async fn post_open_apis_corehr_v2_cost_centers(&self, payload: Option<&Value>) -> SDKResult<Value> {
    ...
    pub async fn patch_open_apis_corehr_v2_cost_centers_by_cost_center_id(&self, cost_center_id: impl AsRef<str>, payload: Option<&Value>) -> SDKResult<Value> {
    ...
    pub async fn get_open_apis_corehr_v2_cost_centers_query_recent_change(&self, payload: Option<&Value>) -> SDKResult<Value> {
    ...
    pub async fn post_open_apis_corehr_v2_cost_centers_search(&self, payload: Option<&Value>) -> SDKResult<Value> {
    ...
    pub async fn delete_open_apis_corehr_v2_cost_centers_by_cost_center_id(&self, cost_center_id: impl AsRef<str>, payload: Option<&Value>) -> SDKResult<Value> {
        let mut path = "/open-apis/corehr/v2/cost_centers/:cost_center_id".to_string();
        path = path.replace(":cost_center_id", cost_center_id.as_ref());
