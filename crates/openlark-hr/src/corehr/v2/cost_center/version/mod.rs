...
impl CostCenterVersion {
    ...
    pub async fn post_open_apis_corehr_v2_cost_centers_by_cost_center_id_versions(
        &self,
    ...
    pub async fn patch_open_apis_corehr_v2_cost_centers_by_cost_center_id_versions_by_version_id(
        &self,
        cost_center_id: impl AsRef<str>,
        ...
        let mut path =
            "/open-apis/corehr/v2/cost_centers/:cost_center_id/versions/:version_id".to_string();
        path = path.replace(":cost_center_id", cost_center_id.as_ref());
    ...
    pub async fn delete_open_apis_corehr_v2_cost_centers_by_cost_center_id_versions_by_version_id(
        &self,
        cost_center_id: impl AsRef<str>,
        version_id: impl AsRef<str>,
        payload: Option<&Value>,
