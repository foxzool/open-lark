...
impl WorkforcePlanDetailRow {
    ...
    pub async fn post_open_apis_corehr_v2_workforce_plan_detail_row_batchsave(&self, payload: Option<&Value>) -> SDKResult<Value> {
    ...
    pub async fn post_open_apis_corehr_v2_workforce_plan_detail_row_batchdelete(&self, payload: Option<&Value>) -> SDKResult<Value> {
