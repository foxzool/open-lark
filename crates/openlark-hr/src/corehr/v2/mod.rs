...
impl CorehrV2 {
    ...
    pub fn basic_info_country_region_subdivision(
        &self,
    ) -> basic_info::country_region_subdivision::BasicInfoCountryRegionSubdivision {
        basic_info::country_region_subdivision::BasicInfoCountryRegionSubdivision::new(
            self.service.clone(),
        )
    }
    ...
    pub fn employees_international_assignment(
        &self,
    ) -> employees::international_assignment::EmployeesInternationalAssignment {
        employees::international_assignment::EmployeesInternationalAssignment::new(
            self.service.clone(),
        )
    }
    ...
    pub fn process_form_variable_data(
        &self,
    ) -> process::form_variable_data::ProcessFormVariableData {
