...
impl Pathway {
    ...
    pub async fn post_open_apis_corehr_v2_pathways(
        ...
        let path = "/open-apis/corehr/v2/pathways".to_string();
    ...
    pub async fn post_open_apis_corehr_v2_pathways_active(
        ...
        let path = "/open-apis/corehr/v2/pathways/active".to_string();
        let method = Method::POST;
        let (query, body) = match method {
            Method::GET | Method::DELETE => (payload, None),
            _ => (None, payload),
    ...
    pub async fn post_open_apis_corehr_v2_pathways_batch_get(
        ...
        let path = "/open-apis/corehr/v2/pathways/batch_get".to_string();
        let method = Method::POST;
        let (query, body) = match method {
            Method::GET | Method::DELETE => (payload, None),
            _ => (None, payload),
