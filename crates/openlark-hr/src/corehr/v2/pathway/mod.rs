...
impl Pathway {
    ...
    pub async fn post_open_apis_corehr_v2_pathways(&self, payload: Option<&Value>) -> SDKResult<Value> {
    ...
    pub async fn patch_open_apis_corehr_v2_pathways_by_pathway_id(&self, pathway_id: impl AsRef<str>, payload: Option<&Value>) -> SDKResult<Value> {
    ...
    pub async fn delete_open_apis_corehr_v2_pathways_by_pathway_id(&self, pathway_id: impl AsRef<str>, payload: Option<&Value>) -> SDKResult<Value> {
        let mut path = "/open-apis/corehr/v2/pathways/:pathway_id".to_string();
        path = path.replace(":pathway_id", pathway_id.as_ref());
    ...
    pub async fn post_open_apis_corehr_v2_pathways_active(&self, payload: Option<&Value>) -> SDKResult<Value> {
    ...
    pub async fn post_open_apis_corehr_v2_pathways_batch_get(&self, payload: Option<&Value>) -> SDKResult<Value> {
