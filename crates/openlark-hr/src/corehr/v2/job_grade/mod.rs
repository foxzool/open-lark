...
impl JobGrade {
    ...
    pub async fn post_open_apis_corehr_v2_job_grades(
        &self,
        payload: Option<&Value>,
    ) -> SDKResult<Value> {
        let path = "/open-apis/corehr/v2/job_grades".to_string();
    ...
    pub async fn patch_open_apis_corehr_v2_job_grades_by_job_grade_id(
        &self,
        job_grade_id: impl AsRef<str>,
        payload: Option<&Value>,
    ) -> SDKResult<Value> {
    ...
    pub async fn post_open_apis_corehr_v2_job_grades_query(
        &self,
        payload: Option<&Value>,
    ) -> SDKResult<Value> {
        let path = "/open-apis/corehr/v2/job_grades/query".to_string();
        let method = Method::POST;
        let (query, body) = match method {
            Method::GET | Method::DELETE => (payload, None),
            _ => (None, payload),
    ...
    pub async fn get_open_apis_corehr_v2_job_grades_query_recent_change(
        &self,
        payload: Option<&Value>,
    ) -> SDKResult<Value> {
        let path = "/open-apis/corehr/v2/job_grades/query_recent_change".to_string();
    ...
    pub async fn delete_open_apis_corehr_v2_job_grades_by_job_grade_id(
        &self,
        job_grade_id: impl AsRef<str>,
        payload: Option<&Value>,
    ) -> SDKResult<Value> {
