...
impl PreHire {
    ...
    pub async fn post_open_apis_corehr_v2_pre_hires_withdraw_onboarding(
        &self,
    ...
    pub async fn post_open_apis_corehr_v2_pre_hires_restore_flow_instance(
        &self,
        payload: Option<&Value>,
    ) -> SDKResult<Value> {
    ...
    pub async fn post_open_apis_corehr_v2_pre_hires(
        &self,
        payload: Option<&Value>,
    ) -> SDKResult<Value> {
    ...
    pub async fn patch_open_apis_corehr_v2_pre_hires_by_pre_hire_id(
        &self,
    ...
    pub async fn delete_open_apis_corehr_v2_pre_hires_by_pre_hire_id(
        &self,
        pre_hire_id: impl AsRef<str>,
        payload: Option<&Value>,
    ) -> SDKResult<Value> {
    ...
    pub async fn post_open_apis_corehr_v2_pre_hires_query(
        &self,
        payload: Option<&Value>,
    ) -> SDKResult<Value> {
    ...
    pub async fn post_open_apis_corehr_v2_pre_hires_search(
        &self,
        payload: Option<&Value>,
    ) -> SDKResult<Value> {
    ...
    pub async fn post_open_apis_corehr_v2_pre_hires_by_pre_hire_id_transit_task(
        &self,
        pre_hire_id: impl AsRef<str>,
        payload: Option<&Value>,
    ) -> SDKResult<Value> {
    ...
    pub async fn post_open_apis_corehr_v2_pre_hires_transform_onboarding_task(
        &self,
        payload: Option<&Value>,
    ) -> SDKResult<Value> {
    ...
    pub async fn post_open_apis_corehr_v2_pre_hires_by_pre_hire_id_complete(
        &self,
        pre_hire_id: impl AsRef<str>,
        payload: Option<&Value>,
    ) -> SDKResult<Value> {
