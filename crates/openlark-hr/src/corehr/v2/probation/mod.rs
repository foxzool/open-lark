...
impl Probation {
    ...
    pub async fn post_open_apis_corehr_v2_probation_enable_disable_assessment(
        &self,
    ...
    pub async fn post_open_apis_corehr_v2_probation_search(
        &self,
        payload: Option<&Value>,
    ) -> SDKResult<Value> {
    ...
    pub async fn post_open_apis_corehr_v2_probation_submit(
        &self,
        payload: Option<&Value>,
    ) -> SDKResult<Value> {
    ...
    pub async fn post_open_apis_corehr_v2_probation_withdraw(
        &self,
        payload: Option<&Value>,
    ) -> SDKResult<Value> {
