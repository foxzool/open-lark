...
impl ProbationAssessment {
    ...
    pub async fn post_open_apis_corehr_v2_probation_assessments(&self, payload: Option<&Value>) -> SDKResult<Value> {
        let mut path = "/open-apis/corehr/v2/probation/assessments".to_string();
    ...
    pub async fn patch_open_apis_corehr_v2_probation_assessments_by_assessment_id(&self, assessment_id: impl AsRef<str>, payload: Option<&Value>) -> SDKResult<Value> {
    ...
    pub async fn delete_open_apis_corehr_v2_probation_assessments_by_assessment_id(&self, assessment_id: impl AsRef<str>, payload: Option<&Value>) -> SDKResult<Value> {
        let mut path = "/open-apis/corehr/v2/probation/assessments/:assessment_id".to_string();
        path = path.replace(":assessment_id", assessment_id.as_ref());
