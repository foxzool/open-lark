...
impl Offboarding {
    ...
    pub async fn post_open_apis_corehr_v2_offboardings_submit_v2(&self, payload: Option<&Value>) -> SDKResult<Value> {
    ...
    pub async fn post_open_apis_corehr_v2_offboardings_edit(&self, payload: Option<&Value>) -> SDKResult<Value> {
    ...
    pub async fn post_open_apis_corehr_v2_offboardings_revoke(&self, payload: Option<&Value>) -> SDKResult<Value> {
