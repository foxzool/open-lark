...
impl Leave {
    ...
    pub async fn get_open_apis_corehr_v1_leaves_leave_types(&self, payload: Option<&Value>) -> SDKResult<Value> {
    ...
    pub async fn get_open_apis_corehr_v1_leaves_leave_balances(&self, payload: Option<&Value>) -> SDKResult<Value> {
    ...
    pub async fn get_open_apis_corehr_v1_leaves_leave_request_history(&self, payload: Option<&Value>) -> SDKResult<Value> {
    ...
    pub async fn post_open_apis_corehr_v1_leaves_work_calendar(&self, payload: Option<&Value>) -> SDKResult<Value> {
    ...
    pub async fn get_open_apis_corehr_v1_leaves_calendar_by_scope(&self, payload: Option<&Value>) -> SDKResult<Value> {
    ...
    pub async fn post_open_apis_corehr_v1_leaves_work_calendar_date(&self, payload: Option<&Value>) -> SDKResult<Value> {
