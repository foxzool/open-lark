...
impl Department {
    ...
    pub async fn post_open_apis_corehr_v1_departments(
        &self,
        payload: Option<&Value>,
    ) -> SDKResult<Value> {
        let path = "/open-apis/corehr/v1/departments".to_string();
    ...
    pub async fn delete_open_apis_corehr_v1_departments_by_department_id(
        &self,
    ...
    pub async fn patch_open_apis_corehr_v1_departments_by_department_id(
        &self,
        department_id: impl AsRef<str>,
        payload: Option<&Value>,
    ) -> SDKResult<Value> {
    ...
    pub async fn get_open_apis_corehr_v1_departments_by_department_id(
        &self,
        department_id: impl AsRef<str>,
        payload: Option<&Value>,
    ) -> SDKResult<Value> {
    ...
    pub async fn get_open_apis_corehr_v1_departments(
        &self,
        payload: Option<&Value>,
    ) -> SDKResult<Value> {
        let path = "/open-apis/corehr/v1/departments".to_string();
