...
impl Subdivision {
    ...
    pub async fn get_open_apis_corehr_v1_subdivisions(&self, payload: Option<&Value>) -> SDKResult<Value> {
    ...
    pub async fn get_open_apis_corehr_v1_subdivisions_by_subdivision_id(&self, subdivision_id: impl AsRef<str>, payload: Option<&Value>) -> SDKResult<Value> {
