...
impl CommonDataMetaData {
    ...
    pub async fn post_open_apis_corehr_v1_common_data_meta_data_add_enum_option(&self, payload: Option<&Value>) -> SDKResult<Value> {
    ...
    pub async fn post_open_apis_corehr_v1_common_data_meta_data_edit_enum_option(&self, payload: Option<&Value>) -> SDKResult<Value> {
