...
impl Company {
    ...
    pub async fn post_open_apis_corehr_v1_companies(
        &self,
        payload: Option<&Value>,
    ) -> SDKResult<Value> {
        let path = "/open-apis/corehr/v1/companies".to_string();
    ...
    pub async fn patch_open_apis_corehr_v1_companies_by_company_id(
        &self,
    ...
    pub async fn get_open_apis_corehr_v1_companies_by_company_id(
        &self,
        company_id: impl AsRef<str>,
        payload: Option<&Value>,
    ) -> SDKResult<Value> {
    ...
    pub async fn get_open_apis_corehr_v1_companies(
        &self,
        payload: Option<&Value>,
    ) -> SDKResult<Value> {
        let path = "/open-apis/corehr/v1/companies".to_string();
    ...
    pub async fn delete_open_apis_corehr_v1_companies_by_company_id(
        &self,
        company_id: impl AsRef<str>,
        payload: Option<&Value>,
    ) -> SDKResult<Value> {
