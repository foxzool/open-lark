...
impl Employment {
    ...
    pub async fn post_open_apis_corehr_v1_employments(
        &self,
        payload: Option<&Value>,
    ) -> SDKResult<Value> {
        let path = "/open-apis/corehr/v1/employments".to_string();
    ...
    pub async fn patch_open_apis_corehr_v1_employments_by_employment_id(
        &self,
        employment_id: impl AsRef<str>,
        payload: Option<&Value>,
    ) -> SDKResult<Value> {
    ...
    pub async fn delete_open_apis_corehr_v1_employments_by_employment_id(
        &self,
        employment_id: impl AsRef<str>,
        payload: Option<&Value>,
    ) -> SDKResult<Value> {
