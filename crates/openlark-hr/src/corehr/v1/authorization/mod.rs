...
impl Authorization {
    ...
    pub async fn get_open_apis_corehr_v1_authorizations_query(
        &self,
    ...
    pub async fn get_open_apis_corehr_v1_authorizations_get_by_param(
        &self,
        payload: Option<&Value>,
    ) -> SDKResult<Value> {
    ...
    pub async fn post_open_apis_corehr_v1_authorizations_add_role_assign(
        &self,
        payload: Option<&Value>,
    ) -> SDKResult<Value> {
    ...
    pub async fn post_open_apis_corehr_v1_authorizations_update_role_assign(
        &self,
        payload: Option<&Value>,
    ) -> SDKResult<Value> {
    ...
    pub async fn post_open_apis_corehr_v1_authorizations_remove_role_assign(
        &self,
        payload: Option<&Value>,
    ) -> SDKResult<Value> {
