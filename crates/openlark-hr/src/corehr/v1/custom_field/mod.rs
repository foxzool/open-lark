...
impl CustomField {
    ...
    pub async fn get_open_apis_corehr_v1_custom_fields_list_object_api_name(&self, payload: Option<&Value>) -> SDKResult<Value> {
    ...
    pub async fn get_open_apis_corehr_v1_custom_fields_query(&self, payload: Option<&Value>) -> SDKResult<Value> {
    ...
    pub async fn get_open_apis_corehr_v1_custom_fields_get_by_param(&self, payload: Option<&Value>) -> SDKResult<Value> {
