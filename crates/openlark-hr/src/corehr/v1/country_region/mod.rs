...
impl CountryRegion {
    ...
    pub async fn get_open_apis_corehr_v1_country_regions(&self, payload: Option<&Value>) -> SDKResult<Value> {
    ...
    pub async fn get_open_apis_corehr_v1_country_regions_by_country_region_id(&self, country_region_id: impl AsRef<str>, payload: Option<&Value>) -> SDKResult<Value> {
