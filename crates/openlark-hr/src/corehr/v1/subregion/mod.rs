...
impl Subregion {
    ...
    pub async fn get_open_apis_corehr_v1_subregions(&self, payload: Option<&Value>) -> SDKResult<Value> {
    ...
    pub async fn get_open_apis_corehr_v1_subregions_by_subregion_id(&self, subregion_id: impl AsRef<str>, payload: Option<&Value>) -> SDKResult<Value> {
