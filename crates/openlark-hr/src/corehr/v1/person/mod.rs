...
impl Person {
    ...
    pub async fn delete_open_apis_corehr_v1_persons_by_person_id(
        &self,
    ...
    pub async fn post_open_apis_corehr_v1_persons_upload(
        &self,
        payload: Option<&Value>,
    ) -> SDKResult<Value> {
    ...
    pub async fn patch_open_apis_corehr_v1_persons_by_person_id(
        &self,
        person_id: impl AsRef<str>,
        payload: Option<&Value>,
    ) -> SDKResult<Value> {
    ...
    pub async fn post_open_apis_corehr_v1_persons(
        &self,
        payload: Option<&Value>,
    ) -> SDKResult<Value> {
    ...
    pub async fn get_open_apis_corehr_v1_persons_by_person_id(
        &self,
        person_id: impl AsRef<str>,
        payload: Option<&Value>,
    ) -> SDKResult<Value> {
