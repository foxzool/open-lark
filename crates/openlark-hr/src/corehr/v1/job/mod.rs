...
impl Job {
    ...
    pub async fn delete_open_apis_corehr_v1_jobs_by_job_id(
        &self,
    ...
    pub async fn patch_open_apis_corehr_v1_jobs_by_job_id(
        &self,
        job_id: impl AsRef<str>,
        payload: Option<&Value>,
    ) -> SDKResult<Value> {
    ...
    pub async fn get_open_apis_corehr_v1_jobs_by_job_id(
        &self,
        job_id: impl AsRef<str>,
        payload: Option<&Value>,
    ) -> SDKResult<Value> {
