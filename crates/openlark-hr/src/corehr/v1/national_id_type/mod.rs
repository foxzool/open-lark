...
impl NationalIdType {
    ...
    pub async fn post_open_apis_corehr_v1_national_id_types(&self, payload: Option<&Value>) -> SDKResult<Value> {
    ...
    pub async fn delete_open_apis_corehr_v1_national_id_types_by_national_id_type_id(&self, national_id_type_id: impl AsRef<str>, payload: Option<&Value>) -> SDKResult<Value> {
    ...
    pub async fn patch_open_apis_corehr_v1_national_id_types_by_national_id_type_id(&self, national_id_type_id: impl AsRef<str>, payload: Option<&Value>) -> SDKResult<Value> {
        let mut path = "/open-apis/corehr/v1/national_id_types/:national_id_type_id".to_string();
        path = path.replace(":national_id_type_id", national_id_type_id.as_ref());
    ...
    pub async fn get_open_apis_corehr_v1_national_id_types_by_national_id_type_id(&self, national_id_type_id: impl AsRef<str>, payload: Option<&Value>) -> SDKResult<Value> {
        let mut path = "/open-apis/corehr/v1/national_id_types/:national_id_type_id".to_string();
        path = path.replace(":national_id_type_id", national_id_type_id.as_ref());
    ...
    pub async fn get_open_apis_corehr_v1_national_id_types(&self, payload: Option<&Value>) -> SDKResult<Value> {
        let mut path = "/open-apis/corehr/v1/national_id_types".to_string();
        let method = Method::GET;
        let (query, body) = match method {
            Method::GET | Method::DELETE => (payload, None),
