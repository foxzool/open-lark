...
impl EmployeeType {
    ...
    pub async fn post_open_apis_corehr_v1_employee_types(
        &self,
        payload: Option<&Value>,
    ) -> SDKResult<Value> {
        let path = "/open-apis/corehr/v1/employee_types".to_string();
    ...
    pub async fn delete_open_apis_corehr_v1_employee_types_by_employee_type_id(
        &self,
        employee_type_id: impl AsRef<str>,
        payload: Option<&Value>,
    ) -> SDKResult<Value> {
    ...
    pub async fn patch_open_apis_corehr_v1_employee_types_by_employee_type_id(
        &self,
        employee_type_id: impl AsRef<str>,
        payload: Option<&Value>,
    ) -> SDKResult<Value> {
    ...
    pub async fn get_open_apis_corehr_v1_employee_types_by_employee_type_id(
        &self,
        employee_type_id: impl AsRef<str>,
        payload: Option<&Value>,
    ) -> SDKResult<Value> {
    ...
    pub async fn get_open_apis_corehr_v1_employee_types(
        &self,
        payload: Option<&Value>,
    ) -> SDKResult<Value> {
        let path = "/open-apis/corehr/v1/employee_types".to_string();
