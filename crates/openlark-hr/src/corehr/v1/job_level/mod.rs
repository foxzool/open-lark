...
impl JobLevel {
    ...
    pub async fn post_open_apis_corehr_v1_job_levels(
        &self,
        payload: Option<&Value>,
    ) -> SDKResult<Value> {
        let path = "/open-apis/corehr/v1/job_levels".to_string();
    ...
    pub async fn patch_open_apis_corehr_v1_job_levels_by_job_level_id(
        &self,
    ...
    pub async fn get_open_apis_corehr_v1_job_levels_by_job_level_id(
        &self,
        job_level_id: impl AsRef<str>,
        payload: Option<&Value>,
    ) -> SDKResult<Value> {
    ...
    pub async fn get_open_apis_corehr_v1_job_levels(
        &self,
        payload: Option<&Value>,
    ) -> SDKResult<Value> {
        let path = "/open-apis/corehr/v1/job_levels".to_string();
    ...
    pub async fn delete_open_apis_corehr_v1_job_levels_by_job_level_id(
        &self,
        job_level_id: impl AsRef<str>,
        payload: Option<&Value>,
    ) -> SDKResult<Value> {
