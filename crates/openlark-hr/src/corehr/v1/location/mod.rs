...
impl Location {
    ...
    pub async fn post_open_apis_corehr_v1_locations(&self, payload: Option<&Value>) -> SDKResult<Value> {
    ...
    pub async fn get_open_apis_corehr_v1_locations_by_location_id(&self, location_id: impl AsRef<str>, payload: Option<&Value>) -> SDKResult<Value> {
    ...
    pub async fn get_open_apis_corehr_v1_locations(&self, payload: Option<&Value>) -> SDKResult<Value> {
        let mut path = "/open-apis/corehr/v1/locations".to_string();
        let method = Method::GET;
        let (query, body) = match method {
            Method::GET | Method::DELETE => (payload, None),
    ...
    pub async fn delete_open_apis_corehr_v1_locations_by_location_id(&self, location_id: impl AsRef<str>, payload: Option<&Value>) -> SDKResult<Value> {
        let mut path = "/open-apis/corehr/v1/locations/:location_id".to_string();
        path = path.replace(":location_id", location_id.as_ref());
