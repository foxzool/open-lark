...
impl Currency {
    ...
    pub async fn get_open_apis_corehr_v1_currencies(
        &self,
        payload: Option<&Value>,
    ) -> SDKResult<Value> {
        let path = "/open-apis/corehr/v1/currencies".to_string();
    ...
    pub async fn get_open_apis_corehr_v1_currencies_by_currency_id(
        &self,
        currency_id: impl AsRef<str>,
        payload: Option<&Value>,
    ) -> SDKResult<Value> {
