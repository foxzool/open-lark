...
impl CommentsService {
    ...
    ) -> SDKResult<open_lark_core::core::api_resp::BaseResponse<ListCommentsResponse>> {
    ...
    pub async fn batch_query(
        ...
        option: Option<RequestOption>,
    ) -> SDKResult<open_lark_core::core::api_resp::BaseResponse<BatchQueryCommentsResponse>> {
    ...
    pub async fn patch(
        ...
        option: Option<RequestOption>,
    ) -> SDKResult<open_lark_core::core::api_resp::BaseResponse<PatchCommentResponse>> {
    ...
    pub async fn create(
        ...
        option: Option<RequestOption>,
    ) -> SDKResult<open_lark_core::core::api_resp::BaseResponse<CreateCommentResponse>> {
    ...
    pub async fn get(
        ...
        option: Option<RequestOption>,
    ) -> SDKResult<open_lark_core::core::api_resp::BaseResponse<GetCommentResponse>> {
    ...
    pub async fn list_replies(
        ...
        option: Option<RequestOption>,
    ) -> SDKResult<open_lark_core::core::api_resp::BaseResponse<ListRepliesResponse>> {
    ...
    pub async fn update_reply(
        ...
        option: Option<RequestOption>,
    ) -> SDKResult<open_lark_core::core::api_resp::BaseResponse<UpdateReplyResponse>> {
    ...
    pub async fn delete_reply(
        ...
        option: Option<RequestOption>,
    ) -> SDKResult<open_lark_core::core::api_resp::BaseResponse<DeleteReplyResponse>> {
