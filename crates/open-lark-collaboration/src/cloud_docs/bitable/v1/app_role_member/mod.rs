...
impl AppRoleMemberService {
    ...
    ) -> open_lark_core::core::SDKResult<open_lark_core::core::api_resp::BaseResponse<BatchCreateRoleMemberResponse>>
    {
    ...
    pub async fn delete(
        ...
        option: Option<open_lark_core::core::req_option::RequestOption>,
    ) -> open_lark_core::core::SDKResult<open_lark_core::core::api_resp::BaseResponse<DeleteRoleMemberResponse>> {
    ...
    pub async fn batch_delete(
        ...
        option: Option<open_lark_core::core::req_option::RequestOption>,
    ) -> open_lark_core::core::SDKResult<open_lark_core::core::api_resp::BaseResponse<BatchDeleteRoleMemberResponse>>
    {
