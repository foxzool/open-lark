...
impl AppDashboardService {
    ...
    ) -> open_lark_core::core::SDKResult<open_lark_core::core::api_resp::BaseResponse<CopyDashboardResponse>> {
    ...
    pub async fn list(
        ...
        option: Option<open_lark_core::core::req_option::RequestOption>,
    ) -> open_lark_core::core::SDKResult<open_lark_core::core::api_resp::BaseResponse<ListDashboardResponse>> {
