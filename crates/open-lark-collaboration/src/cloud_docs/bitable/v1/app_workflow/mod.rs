...
impl AppWorkflowService {
    ...
    ) -> open_lark_core::core::SDKResult<open_lark_core::core::api_resp::BaseResponse<ListWorkflowResponse>> {
    ...
    pub async fn update(
        ...
        option: Option<open_lark_core::core::req_option::RequestOption>,
    ) -> open_lark_core::core::SDKResult<open_lark_core::core::api_resp::BaseResponse<UpdateWorkflowResponse>> {
