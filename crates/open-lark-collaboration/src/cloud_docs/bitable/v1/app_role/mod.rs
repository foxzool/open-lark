...
impl AppRoleService {
    ...
    ) -> open_lark_core::core::SDKResult<open_lark_core::core::api_resp::BaseResponse<UpdateAppRoleResponse>> {
    ...
    pub async fn list(
        ...
        option: Option<open_lark_core::core::req_option::RequestOption>,
    ) -> open_lark_core::core::SDKResult<open_lark_core::core::api_resp::BaseResponse<ListAppRoleResponse>> {
    ...
    pub async fn delete(
        ...
        option: Option<open_lark_core::core::req_option::RequestOption>,
    ) -> open_lark_core::core::SDKResult<open_lark_core::core::api_resp::BaseResponse<DeleteAppRoleResponse>> {
