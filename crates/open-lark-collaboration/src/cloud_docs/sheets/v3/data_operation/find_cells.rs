...
impl FindCellsRequest {
    ...
    pub fn validate(&self) -> SDKResult<()> {
        ...
        if self.spreadsheet_token.is_empty() {
            return Err(open_lark_core::core::error::LarkAPIError::illegal_param(
        ...
        if let ValidationResult::Invalid(msg) = validation::validate_find_options(
            ...
            return Err(open_lark_core::core::error::LarkAPIError::illegal_param(format!(
...
impl SpreadsheetSheetService {
    ...
    pub async fn find_cells(
        ...
        let api_resp: BaseResponse<FindCellsResponse> =
            open_lark_core::core::http::Transport::request(api_req, &self.config, option).await?;
