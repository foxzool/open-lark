...
impl SpreadsheetService {
    ...
    pub async fn write_data_to_single_range(
        ...
        api_req.set_api_path(SHEETS_V2_SPREADSHEET_VALUES.replace("{}", &request.spreadsheet_token));
...
mod tests {
    ...
    fn test_write_data_to_single_range_response_type() {
        use crate::cloud_docs::sheets::v2::data_operation::WriteDataToSingleRangeResponse;
        use std::any::TypeId;
