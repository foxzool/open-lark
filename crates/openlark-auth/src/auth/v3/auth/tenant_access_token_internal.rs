...
/// 自建应用租户访问令牌服务
pub struct TenantAccessTokenInternalService {
    config: Config,
}

impl TenantAccessTokenInternalService {
    /// 创建新的服务实例
    pub fn new(config: Config) -> Self {
        Self { config }
    }
    ...
    /// 获取自建应用租户访问令牌（使用配置中的凭证）
    pub fn from_config(&self) -> TenantAccessTokenInternalBuilder {
...
mod tests {
    ...
    #[test]
    fn test_tenant_access_token_internal_request_creation() {
        let request = TenantAccessTokenInternalRequest {
    ...
    #[test]
    fn test_tenant_internal_builder_from_config() {
        ...
        let builder = TenantAccessTokenInternalBuilder::new(config.clone())
            .from_config();
    ...
    #[test]
    fn test_tenant_internal_builder_custom_credentials() {
    ...
    #[test]
    fn test_tenant_internal_service_creation() {
        let config = Config::builder()
            .app_id("test_app_id")
            .app_secret("test_app_secret")
            .app_type(openlark_core::constants::AppType::SelfBuild)
        ...
        let service = TenantAccessTokenInternalService::new(config.clone());
    ...
    #[test]
    fn test_tenant_internal_service_custom_credentials() {
        let config = Config::builder().build();
        let service = TenantAccessTokenInternalService::new(config);
    ...
    #[test]
    fn test_tenant_internal_service_from_auth_config() {
        let auth_config = AuthConfig::new("test_app_id", "test_app_secret");
        let service = TenantAccessTokenInternalService::from_auth_config(auth_config);
