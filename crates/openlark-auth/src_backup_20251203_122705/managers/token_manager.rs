...
impl TokenManager {
    /// 创建新的令牌管理器
    pub fn new(config: AuthConfig) -> SDKResult<Self> {
    ...
    /// 获取访问令牌（主要入口方法）
    pub async fn get_access_token(&self, request: GetTokenRequest) -> SDKResult<GetTokenResponse> {
    ...
    /// 获取应用访问令牌信息
    async fn get_app_token_info(&self) -> SDKResult<TokenInfo> {
    ...
    /// 获取租户访问令牌信息
    async fn get_tenant_token_info(&self, tenant_key: &str) -> SDKResult<TokenInfo> {
    ...
    /// 获取用户访问令牌信息
    async fn get_user_token_info(&self, refresh_token: &str) -> SDKResult<TokenInfo> {
    ...
    /// 验证访问令牌
    pub async fn validate_access_token(&self, token: &str) -> SDKResult<TokenValidationResult> {
    ...
    /// 刷新访问令牌
    pub async fn refresh_access_token(&self, refresh_token: &str) -> SDKResult<GetTokenResponse> {
    ...
    /// 撤销访问令牌
    pub async fn revoke_access_token(&self, token: &str) -> SDKResult<()> {
    ...
    /// 获取令牌信息
    pub async fn get_token_info(&self, token: &str) -> SDKResult<TokenInfo> {
    ...
    ) -> Vec<SDKResult<GetTokenResponse>> {
    ...
    /// 清空所有令牌缓存
    pub async fn clear_all_tokens(&self) -> SDKResult<()> {
    ...
    /// 预热令牌缓存
    pub async fn warmup_tokens(&self, tenant_keys: Vec<String>) -> SDKResult<()> {
    ...
    /// 清理过期令牌
    pub async fn cleanup_expired_tokens(&self) -> SDKResult<usize> {
    ...
    /// 检查令牌是否需要刷新
    pub async fn should_refresh_token(&self, token: &str) -> SDKResult<bool> {
