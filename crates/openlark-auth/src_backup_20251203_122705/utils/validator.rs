...
use crate::error::{AuthError, SDKResult};
use regex::Regex;
use url::Url;
...
impl ValidatorUtils {
    ...
    /// 验证URL格式并返回错误
    pub fn validate_url(url: &str) -> SDKResult<()> {
        if !Self::is_valid_url(url) {
            return Err(crate::error::validation_error("url", "URL格式无效".to_string()));
        }
        Ok(())
    }
    ...
    /// 验证HTTPS URL并返回错误
    pub fn validate_https_url(url: &str) -> SDKResult<()> {
    ...
    /// 验证手机号格式并返回错误
    pub fn validate_phone_cn(phone: &str) -> SDKResult<()> {
    ...
    /// 验证IP地址格式（IPv4）并返回错误
    pub fn validate_ipv4(ip: &str) -> SDKResult<()> {
    ...
    /// 验证IP地址格式（IPv6）并返回错误
    pub fn validate_ipv6(ip: &str) -> SDKResult<()> {
    ...
    /// 验证IP地址格式并返回错误
    pub fn validate_ip(ip: &str) -> SDKResult<()> {
    ...
    /// 验证UUID格式并返回错误
    pub fn validate_uuid(uuid: &str) -> SDKResult<()> {
    ...
    /// 验证应用ID格式并返回错误
    pub fn validate_app_id(app_id: &str) -> SDKResult<()> {
    ...
    /// 验证访问令牌格式并返回错误
    pub fn validate_access_token(token: &str) -> SDKResult<()> {
    ...
    /// 验证刷新令牌格式并返回错误
    pub fn validate_refresh_token(token: &str) -> SDKResult<()> {
    ...
    /// 验证状态参数格式并返回错误
    pub fn validate_state(state: &str) -> SDKResult<()> {
    ...
    /// 验证权限范围格式并返回错误
    pub fn validate_scope(scope: &str) -> SDKResult<()> {
    ...
    /// 验证重定向URI格式并返回错误
    pub fn validate_redirect_uri(uri: &str) -> SDKResult<()> {
    ...
    /// 验证租户密钥格式并返回错误
    pub fn validate_tenant_key(tenant_key: &str) -> SDKResult<()> {
    ...
    /// 验证用户ID格式并返回错误
    pub fn validate_user_id(user_id: &str) -> SDKResult<()> {
    ...
    /// 验证时间戳格式并返回错误
    pub fn validate_timestamp(timestamp: u64) -> SDKResult<()> {
    ...
    /// 验证JSON格式并返回错误
    pub fn validate_json(json: &str) -> SDKResult<()> {
    ...
    /// 验证Base64格式并返回错误
    pub fn validate_base64(data: &str) -> SDKResult<()> {
    ...
    /// 验证十六进制字符串并返回错误
    pub fn validate_hex(hex: &str) -> SDKResult<()> {
