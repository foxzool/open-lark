...
impl JobFamily {
    ...
    pub async fn post_open_apis_contact_v3_job_families(&self, payload: Option<&Value>) -> SDKResult<Value> {
    ...
    pub async fn put_open_apis_contact_v3_job_families_by_job_family_id(&self, job_family_id: impl AsRef<str>, payload: Option<&Value>) -> SDKResult<Value> {
    ...
    pub async fn get_open_apis_contact_v3_job_families_by_job_family_id(&self, job_family_id: impl AsRef<str>, payload: Option<&Value>) -> SDKResult<Value> {
        let mut path = "/open-apis/contact/v3/job_families/:job_family_id".to_string();
        path = path.replace(":job_family_id", job_family_id.as_ref());
    ...
    pub async fn get_open_apis_contact_v3_job_families(&self, payload: Option<&Value>) -> SDKResult<Value> {
        let mut path = "/open-apis/contact/v3/job_families".to_string();
        let method = Method::GET;
        let (query, body) = match method {
            Method::GET | Method::DELETE => (payload, None),
    ...
    pub async fn delete_open_apis_contact_v3_job_families_by_job_family_id(&self, job_family_id: impl AsRef<str>, payload: Option<&Value>) -> SDKResult<Value> {
        let mut path = "/open-apis/contact/v3/job_families/:job_family_id".to_string();
        path = path.replace(":job_family_id", job_family_id.as_ref());
