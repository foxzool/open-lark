...
impl Unit {
    ...
    pub async fn post_open_apis_contact_v3_unit(&self, payload: Option<&Value>) -> SDKResult<Value> {
    ...
    pub async fn patch_open_apis_contact_v3_unit_by_unit_id(&self, unit_id: impl AsRef<str>, payload: Option<&Value>) -> SDKResult<Value> {
    ...
    pub async fn post_open_apis_contact_v3_unit_bind_department(&self, payload: Option<&Value>) -> SDKResult<Value> {
    ...
    pub async fn post_open_apis_contact_v3_unit_unbind_department(&self, payload: Option<&Value>) -> SDKResult<Value> {
    ...
    pub async fn get_open_apis_contact_v3_unit_list_department(&self, payload: Option<&Value>) -> SDKResult<Value> {
    ...
    pub async fn get_open_apis_contact_v3_unit_by_unit_id(&self, unit_id: impl AsRef<str>, payload: Option<&Value>) -> SDKResult<Value> {
        let mut path = "/open-apis/contact/v3/unit/:unit_id".to_string();
        path = path.replace(":unit_id", unit_id.as_ref());
        let method = Method::GET;
        let (query, body) = match method {
    ...
    pub async fn delete_open_apis_contact_v3_unit_by_unit_id(&self, unit_id: impl AsRef<str>, payload: Option<&Value>) -> SDKResult<Value> {
        let mut path = "/open-apis/contact/v3/unit/:unit_id".to_string();
        path = path.replace(":unit_id", unit_id.as_ref());
