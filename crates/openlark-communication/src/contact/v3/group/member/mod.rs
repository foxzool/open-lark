...
impl GroupMember {
    ...
    pub async fn post_open_apis_contact_v3_group_by_group_id_member_add(&self, group_id: impl AsRef<str>, payload: Option<&Value>) -> SDKResult<Value> {
    ...
    pub async fn post_open_apis_contact_v3_group_by_group_id_member_batch_add(&self, group_id: impl AsRef<str>, payload: Option<&Value>) -> SDKResult<Value> {
    ...
    pub async fn get_open_apis_contact_v3_group_by_group_id_member_simplelist(&self, group_id: impl AsRef<str>, payload: Option<&Value>) -> SDKResult<Value> {
    ...
    pub async fn post_open_apis_contact_v3_group_by_group_id_member_remove(&self, group_id: impl AsRef<str>, payload: Option<&Value>) -> SDKResult<Value> {
    ...
    pub async fn post_open_apis_contact_v3_group_by_group_id_member_batch_remove(&self, group_id: impl AsRef<str>, payload: Option<&Value>) -> SDKResult<Value> {
