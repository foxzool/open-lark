...
impl EmployeeTypeEnum {
    ...
    pub async fn post_open_apis_contact_v3_employee_type_enums(&self, payload: Option<&Value>) -> SDKResult<Value> {
    ...
    pub async fn put_open_apis_contact_v3_employee_type_enums_by_enum_id(&self, enum_id: impl AsRef<str>, payload: Option<&Value>) -> SDKResult<Value> {
    ...
    pub async fn get_open_apis_contact_v3_employee_type_enums(&self, payload: Option<&Value>) -> SDKResult<Value> {
        let mut path = "/open-apis/contact/v3/employee_type_enums".to_string();
    ...
    pub async fn delete_open_apis_contact_v3_employee_type_enums_by_enum_id(&self, enum_id: impl AsRef<str>, payload: Option<&Value>) -> SDKResult<Value> {
        let mut path = "/open-apis/contact/v3/employee_type_enums/:enum_id".to_string();
        path = path.replace(":enum_id", enum_id.as_ref());
