...
impl WorkCity {
    ...
    pub async fn get_open_apis_contact_v3_work_cities_by_work_city_id(&self, work_city_id: impl AsRef<str>, payload: Option<&Value>) -> SDKResult<Value> {
    ...
    pub async fn get_open_apis_contact_v3_work_cities(&self, payload: Option<&Value>) -> SDKResult<Value> {
