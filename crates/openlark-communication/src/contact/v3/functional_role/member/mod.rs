...
impl FunctionalRoleMember {
    ...
    pub async fn post_open_apis_contact_v3_functional_roles_by_role_id_members_batch_create(
        &self,
        role_id: impl AsRef<str>,
        payload: Option<&Value>,
    ) -> SDKResult<Value> {
        let mut path =
            "/open-apis/contact/v3/functional_roles/:role_id/members/batch_create".to_string();
    ...
    pub async fn patch_open_apis_contact_v3_functional_roles_by_role_id_members_scopes(
        &self,
        role_id: impl AsRef<str>,
        payload: Option<&Value>,
    ) -> SDKResult<Value> {
    ...
    pub async fn get_open_apis_contact_v3_functional_roles_by_role_id_members_by_member_id(
        &self,
        role_id: impl AsRef<str>,
        ...
        let mut path =
            "/open-apis/contact/v3/functional_roles/:role_id/members/:member_id".to_string();
        path = path.replace(":role_id", role_id.as_ref());
    ...
    pub async fn get_open_apis_contact_v3_functional_roles_by_role_id_members(
        &self,
        role_id: impl AsRef<str>,
        payload: Option<&Value>,
    ) -> SDKResult<Value> {
    ...
    pub async fn patch_open_apis_contact_v3_functional_roles_by_role_id_members_batch_delete(
        &self,
        role_id: impl AsRef<str>,
        payload: Option<&Value>,
    ) -> SDKResult<Value> {
        let mut path =
            "/open-apis/contact/v3/functional_roles/:role_id/members/batch_delete".to_string();
        path = path.replace(":role_id", role_id.as_ref());
        let method = Method::PATCH;
        let (query, body) = match method {
            Method::GET | Method::DELETE => (payload, None),
