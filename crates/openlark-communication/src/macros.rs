...
macro_rules! impl_basic_service {
    ($service_type:ty, $name:expr, $version:expr) => {
        impl openlark_core::trait_system::Service for $service_type {
        ...
        impl openlark_core::trait_system::ServiceObservability for $service_type {}

        impl openlark_core::trait_system::ServiceBuilder<$service_type> for $service_type {
            fn build(config: openlark_core::config::Config) -> $service_type {
                Self { config }
            }
        }
    };
...
macro_rules! impl_async_service {
    ($service_type:ty, $request_type:ty, $response_type:ty) => {
        impl openlark_core::trait_system::AsyncServiceOperation<$request_type, $response_type>
            for $service_type
        {
        }
    };
...
macro_rules! impl_service_health_check {
    ($service_type:ty) => {
        impl openlark_core::trait_system::ServiceHealthCheck for $service_type {
            async fn health_check(
                &self,
            ) -> openlark_core::SDKResult<openlark_core::trait_system::ServiceHealthStatus> {
                use openlark_core::trait_system::ServiceHealthStatus;
...
macro_rules! impl_configurable_service {
    ($service_type:ty) => {
        impl openlark_core::trait_system::ConfigurableService for $service_type {
            fn update_config(
                &mut self,
                new_config: openlark_core::config::Config,
...
macro_rules! impl_full_service {
    ...
    ($service_type:ty, $name:expr, $version:expr) => {
        openlark_core::impl_basic_service!($service_type, $name, $version);
        openlark_core::impl_service_health_check!($service_type);
        openlark_core::impl_configurable_service!($service_type);
    };
}
    ...
    ($service_type:ty) => {
        impl $service_type {
            ...
            pub fn new(config: openlark_core::config::Config) -> Self {
                <Self as openlark_core::trait_system::ServiceBuilder<Self>>::build(config)
            }
        }
    };
}
