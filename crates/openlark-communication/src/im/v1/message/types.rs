...
use openlark_core::api_resp::ApiResponseTrait;
...
///
/// ```rust
/// use open_lark::im::v1::message::{MessageText, SendMessageTrait};
///
...
impl openlark_core::api_resp::ApiResponseTrait for CreateMessageResp {
