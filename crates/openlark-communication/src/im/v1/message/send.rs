...
impl MessageService {
    ...
    pub async fn create(
        ...
        api_req.set_api_path(openlark_core::endpoints::im::IM_V1_SEND_MESSAGE.to_string());
        api_req
    ...
    pub async fn delete(&self, message_id: &str, option: Option<RequestOption>) -> SDKResult<()> {
        ...
        api_req.set_api_path(EndpointBuilder::replace_param(
            openlark_core::endpoints::im::IM_V1_DELETE_MESSAGE,
            "message_id",
            message_id,
        ));
        api_req
    ...
    pub async fn update(
        ...
        api_req.set_api_path(EndpointBuilder::replace_param(
            openlark_core::endpoints::im::IM_V1_UPDATE_MESSAGE,
            "message_id",
            message_id,
        ));
        api_req
    ...
    pub async fn reply(
        ...
        api_req.set_http_method(Method::POST);
        api_req.set_api_path(EndpointBuilder::replace_param(
            openlark_core::endpoints::im::IM_V1_REPLY_MESSAGE,
            "message_id",
            message_id,
        ));
        api_req
...
mod tests {
    ...
    fn create_test_update_message_request() -> UpdateMessageRequest {
        let mut api_req = ApiRequest::default();
        let body_json = serde_json::json!({
    ...
    fn test_delete_message_endpoint_construction() {
        ...
        let expected_path = openlark_core::endpoints::im::IM_V1_DELETE_MESSAGE
            .replace("{message_id}", message_id);

        let constructed_path = openlark_core::endpoints::EndpointBuilder::replace_param(
            openlark_core::endpoints::im::IM_V1_DELETE_MESSAGE,
            "message_id",
            message_id,
        );
    ...
    fn test_delete_message_request_structure() {
        ...
        api_req.set_api_path(
            openlark_core::endpoints::EndpointBuilder::replace_param(
                openlark_core::endpoints::im::IM_V1_DELETE_MESSAGE,
                "message_id",
                message_id,
            ),
    ...
    fn test_update_message_endpoint_construction() {
        ...
        let expected_path = openlark_core::endpoints::im::IM_V1_UPDATE_MESSAGE
            .replace("{message_id}", message_id);
    ...
    fn test_reply_message_endpoint_construction() {
        ...
        let expected_path = openlark_core::endpoints::im::IM_V1_REPLY_MESSAGE
            .replace("{message_id}", message_id);
    ...
    fn test_message_request_endpoint_validations() {
        ...
        assert_eq!(
            openlark_core::endpoints::im::IM_V1_SEND_MESSAGE,
            "/open-apis/im/v1/messages"
        );

        // Test delete message endpoint pattern
        let delete_endpoint = openlark_core::endpoints::im::IM_V1_DELETE_MESSAGE;
        ...
        let update_endpoint = openlark_core::endpoints::im::IM_V1_UPDATE_MESSAGE;
        ...
        let reply_endpoint = openlark_core::endpoints::im::IM_V1_REPLY_MESSAGE;
    ...
    fn test_message_id_validation() {
        ...
        for message_id in valid_message_ids {
            ...
            let path = openlark_core::endpoints::EndpointBuilder::replace_param(
                openlark_core::endpoints::im::IM_V1_DELETE_MESSAGE,
                "message_id",
                message_id,
            );
    ...
    fn test_error_types() {
        ...
        fn _check_update_result() -> SDKResult<Message> {
            unimplemented!("Mock implementation")
        }

        fn _check_reply_result() -> SDKResult<Message> {
            unimplemented!("Mock implementation")
        }
    ...
    fn test_endpoint_constants_exist() {
        ...
        let _create_endpoint = openlark_core::endpoints::im::IM_V1_SEND_MESSAGE;
        let _delete_endpoint = openlark_core::endpoints::im::IM_V1_DELETE_MESSAGE;
        let _update_endpoint = openlark_core::endpoints::im::IM_V1_UPDATE_MESSAGE;
        let _reply_endpoint = openlark_core::endpoints::im::IM_V1_REPLY_MESSAGE;
    ...
    fn test_message_types_import() {
        ...
        use crate::im::v1::message::{CreateMessageResp, Message, MessageService};
    ...
    fn test_error_handling_patterns() {
        ...
        let sdk_result: openlark_core::SDKResult<()> = Err(error);
