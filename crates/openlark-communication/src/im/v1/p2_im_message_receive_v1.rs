...
use openlark_core::event::{context::EventHeader, dispatcher::EventHandler};
...
mod test {
    ...
    use openlark_core::event::context::EventContext;

    #[test]
    fn test_decode() {
        let p1 = json!({"schema":"2.0","header":{"event_id":"7db4fd0bb90cfa6127e3aaa446d39b37","token":"","create_time":"1719211482721","event_type":"im.message.receive_v1","tenant_key":"tenant_key","app_id":"app_id"},"event":{"message":{"chat_id":"oc_84d53efe245072c16ba4b4ff597f52f3","chat_type":"group","content":"{\"text\":\"55u\"}","create_time":"1719211482485","message_id":"om_b1e37040d3f888af8a7e47affae94360","message_type":"text","update_time":"1719211482485"},"sender":{"sender_id":{"open_id":"ou_b434284f852b1531071855b16d19f40b","union_id":"on_526dbf7b9ef1fda341aecb79a2481662","user_id":"aa5cf9d7"},"sender_type":"user","tenant_key":"133195a24e8f575d"}}});
