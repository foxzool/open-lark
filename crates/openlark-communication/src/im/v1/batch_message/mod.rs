...
impl BatchMessageService {
    ...
    pub async fn send(
        ...
        api_req.set_api_path(openlark_core::endpoints::im::IM_V1_BATCH_MESSAGES.to_string());
        api_req
            .set_supported_access_token_types(vec![AccessTokenType::Tenant, AccessTokenType::User]);

        let mut query_params = HashMap::new();
        query_params.insert("receive_id_type", receive_id_type.as_str().to_string());
    ...
    pub async fn delete(
        ...
        api_req.set_api_path(EndpointBuilder::replace_param(
            openlark_core::endpoints::im::IM_V1_BATCH_MESSAGES_DELETE,
            "batch_message_id",
            batch_message_id,
        ));
        api_req
    ...
    pub async fn get_progress(
        ...
        api_req.set_api_path(EndpointBuilder::replace_param(
            openlark_core::endpoints::im::IM_V1_BATCH_MESSAGE_PROGRESS,
            "batch_message_id",
            batch_message_id,
        ));
        api_req
    ...
    pub async fn read_user(
        ...
        api_req.set_http_method(Method::GET);
        api_req.set_api_path(EndpointBuilder::replace_param(
            openlark_core::endpoints::im::IM_V1_BATCH_MESSAGE_READ_USER,
            "batch_message_id",
            batch_message_id,
        ));
        api_req
