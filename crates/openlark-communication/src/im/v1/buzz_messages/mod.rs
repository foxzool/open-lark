...
impl BuzzMessagesService {
    ...
    pub async fn urgent_app(
        ...
        api_req.set_api_path(EndpointBuilder::replace_param(
            openlark_core::endpoints::im::IM_V1_MESSAGE_URGENT_APP,
            "message_id",
            message_id,
        ));
        api_req
    ...
    pub async fn urgent_sms(
        ...
        api_req.set_http_method(Method::PATCH);
        api_req.set_api_path(EndpointBuilder::replace_param(
            openlark_core::endpoints::im::IM_V1_MESSAGE_URGENT_SMS,
            "message_id",
            message_id,
        ));
        api_req
    ...
    pub async fn urgent_phone(
        ...
        api_req.set_http_method(Method::PATCH);
        api_req.set_api_path(EndpointBuilder::replace_param(
            openlark_core::endpoints::im::IM_V1_MESSAGE_URGENT_PHONE,
            "message_id",
            message_id,
        ));
        api_req
