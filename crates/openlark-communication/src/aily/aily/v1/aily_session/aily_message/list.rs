...
///
/// ```rust,ignore
/// let request = ListAilyMessagesRequest::new(config)
...
mod tests {
    ...
    #[test]
    fn test_list_aily_messages_request_builder() {
        let config = Config::default();
        let request = ListAilyMessagesRequest::new(config).aily_session_id("session_xxx");
        assert_eq!(request.aily_session_id, "session_xxx");
    }

    #[test]
    fn test_list_aily_messages_request_with_query_param() {
        let config = Config::default();
        let request = ListAilyMessagesRequest::new(config)
            .aily_session_id("session_xxx")
            .query_param("page_size", "50");
    ...
    #[test]
    fn test_list_aily_messages_request_default_values() {
        let config = Config::default();
        let request = ListAilyMessagesRequest::new(config);
    ...
    #[test]
    fn test_list_aily_messages_request_with_multiple_params() {
        let config = Config::default();
        let request = ListAilyMessagesRequest::new(config)
            .aily_session_id("session_xxx")
            .query_param("page_size", "50")
