...
use crate::{common::api_utils::{extract_response_data, serialize_params}, endpoints::CALENDAR_V4_EXCHANGE_BINDINGS};
...
impl CreateExchangeBindingRequest {
    ...
    pub async fn execute(self, body: serde_json::Value) -> SDKResult<serde_json::Value> {
        // url: POST:/open-apis/calendar/v4/exchange_bindings
        let req: ApiRequest<serde_json::Value> =
            ApiRequest::post(CALENDAR_V4_EXCHANGE_BINDINGS)
