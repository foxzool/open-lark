...
impl<'a> BaikeV1Service<'a> {
    ...
    /// 更新免审词条
    /// API文档: https://open.feishu.cn/document/server-docs/baike-v1/entity/update
    ...
    /// 获取词条列表
    /// API文档: https://open.feishu.cn/document/server-docs/baike-v1/entity/list
    ...
    pub fn extract_entities(&self, text: String) -> ExtractEntityBuilder<'a> {
        ExtractEntityBuilder::new(self.config, text)
    }
    ...
    /// 下载图片
    /// API文档: https://open.feishu.cn/document/server-docs/baike-v1/file/download
