//! 精准搜索词条
//!
//! doc: https://open.feishu.cn/document/lingo-v1/entity/match
...
impl MatchEntityBuilder {
    pub fn new(word: impl ToString) -> Self {
        ...
        builder.api_req.req_type = "lingo_entity_match".to_string();
        builder.api_req.method = "POST".to_string();
        builder.api_req.url = "https://open.feishu.cn/open-apis/lingo/v1/entities/match".to_string();
