...
mod tests {
    ...
    fn test_sheet_apis() {
        ...
        let _create_func: fn(&openlark_core::Config, &str) -> _ =
    ...
    fn test_filter_apis() {
        // 验证筛选功能API
        let _create_func: fn(&openlark_core::Config, &str, &str) -> _ =
            spreadsheet::sheet::filter::create_filter;
        let _get_func: fn(&openlark_core::Config, &str, &str) -> _ =
            spreadsheet::sheet::filter::get_filter;
        let _update_func: fn(&openlark_core::Config, &str, &str) -> _ =
            spreadsheet::sheet::filter::update_filter;
        let _delete_func: fn(&openlark_core::Config, &str, &str) -> _ =
    ...
    fn test_filter_view_apis() {
        ...
        let _query_func: fn(&openlark_core::Config, &str, &str) -> _ =
            spreadsheet::sheet::filter_view::query_filter_views;
        let _get_func: fn(&openlark_core::Config, &str, &str, &str) -> _ =
            spreadsheet::sheet::filter_view::get_filter_view;
        let _patch_func: fn(&openlark_core::Config, &str, &str, &str) -> _ =
            spreadsheet::sheet::filter_view::update_filter_view;
        let _delete_func: fn(&openlark_core::Config, &str, &str, &str) -> _ =
    ...
    fn test_filter_condition_apis() {
        // 验证筛选条件API
        let _create_func: fn(&openlark_core::Config, &str, &str, &str) -> _ =
            spreadsheet::sheet::filter_view::condition::create_filter_condition;
        let _get_func: fn(&openlark_core::Config, &str, &str, &str, &str) -> _ =
            spreadsheet::sheet::filter_view::condition::get_filter_condition;
        let _query_func: fn(&openlark_core::Config, &str, &str, &str) -> _ =
            spreadsheet::sheet::filter_view::condition::query_filter_conditions;
        let _update_func: fn(&openlark_core::Config, &str, &str, &str, &str) -> _ =
            spreadsheet::sheet::filter_view::condition::update_filter_condition;
        let _delete_func: fn(&openlark_core::Config, &str, &str, &str, &str) -> _ =
    ...
    fn test_data_operation_apis() {
        // 验证数据操作API
        let _insert_rows_func: fn(&openlark_core::Config, &str, &str) -> _ =
            spreadsheet::sheet::data_operation::insert_rows;
        let _insert_columns_func: fn(&openlark_core::Config, &str, &str) -> _ =
            spreadsheet::sheet::data_operation::insert_columns;
        let _delete_range_func: fn(&openlark_core::Config, &str, &str) -> _ =
