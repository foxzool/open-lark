...
mod tests {
    ...
    fn test_check_task_status_params() {
        ...
        assert_eq!(params.task_type, Some("export".to_string()));
    }
    ...
    fn test_multiple_task_types() {
        ...
        assert_eq!(import_builder.request.task_type, Some("import".to_string()));
        assert_eq!(export_builder.request.task_type, Some("export".to_string()));
        assert_eq!(convert_builder.request.task_type, Some("convert".to_string()));
    }
}