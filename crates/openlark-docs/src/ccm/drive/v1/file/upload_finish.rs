...
pub async fn upload_finish(
    ...
    // 构建API端点
    let url = "/open-apis/drive/v1/files/upload_finish";
...
mod tests {
    ...
    fn test_upload_finish_info() {
        let file_info = UploadFinishInfo {
            ...
            name: "uploaded_file.zip".to_string(),
        ...
        assert_eq!(file_info.name, "uploaded_file.zip");
        assert_eq!(file_info.size, 10485760);
    }
