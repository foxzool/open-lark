...
pub struct UpdateProtectedRangeParams {
    /// 电子表格的 token
    #[serde(rename = "spreadsheetToken")]
    pub spreadsheet_token: String,
    /// 保护范围请求列表
    #[serde(rename = "protectedRangeRequests")]
    pub protected_range_requests: Vec<ProtectedRangeRequest>,
}

/// 保护范围请求
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct ProtectedRangeRequest {
    /// 请求类型
    #[serde(rename = "type")]
    pub request_type: String,
    /// 保护范围ID
    #[serde(rename = "protectedRangeId", skip_serializing_if = "Option::is_none")]
...
/// 更新保护范围响应
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct UpdateProtectedRangeResponse {
    /// 更新结果
    pub data: Option<UpdateProtectedRangeResult>,
}

/// 更新保护范围结果
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct UpdateProtectedRangeResult {
    /// 电子表格的 token
    #[serde(rename = "spreadsheetToken")]
    pub spreadsheet_token: String,
    /// 保护范围列表
...
impl ApiResponseTrait for UpdateProtectedRangeResponse {
...
impl UpdateProtectedRangeRequest {
    ...
    pub async fn execute(
    ...
    ) -> SDKResult<UpdateProtectedRangeResponse> {
        // 验证必填字段
        ...
        let api_request: ApiRequest<UpdateProtectedRangeResponse> = ApiRequest::post(
            &api_endpoint.to_url(),
        )
