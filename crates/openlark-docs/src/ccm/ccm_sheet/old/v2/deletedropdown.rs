...
pub struct DeleteDropdownResult {
    ...
    pub spreadsheet_token: String,
    /// 删除的数据验证规则ID列表
    #[serde(rename = "deletedDataValidationRuleIds", skip_serializing_if = "Option::is_none")]
...
impl DeleteDropdownRequest {
    ...
    pub async fn execute(
        self,
        params: DeleteDropdownParams,
    ) -> SDKResult<DeleteDropdownResponse> {
        // 验证必填字段
        ...
        let mut api_request: ApiRequest<DeleteDropdownResponse> =
