...
//!
//! 批量更新块的富文本内容。
//! API文档: https://open.feishu.cn/document/group/upgraded-group-announcement/chat-announcement-block/update
...
use crate::ccm::docx::{BlockUpdate, BatchOperationResult, FailedItem};
