...
impl CreateDocumentBlockDescendantRequest {
    ...
    pub async fn execute(self, params: CreateDocumentBlockDescendantParams) -> SDKResult<CreateDocumentBlockDescendantResponse> {
        ...
        let url = format!("/open-apis/docx/v1/documents/{}/blocks/{}/descendant", params.document_id, params.block_id);
        let mut api_request: ApiRequest<CreateDocumentBlockDescendantResponse> = ApiRequest::post(&url);
