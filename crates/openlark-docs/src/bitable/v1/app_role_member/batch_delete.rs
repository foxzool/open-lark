...
impl BatchDeleteRoleMemberRequest {
    /// 创建批量删除协作者请求
    pub fn new(app_token: String, role_id: String, member_ids: Vec<String>) -> Self {
        Self {
...
impl AppRoleMemberService {
    pub fn batch_delete_builder(&self, role_id: String, member_ids: Vec<String>) -> BatchDeleteRoleMemberRequest {
        BatchDeleteRoleMemberRequest::new(self.app_token.clone(), role_id, member_ids)
    }
}