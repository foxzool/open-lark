//! Bitable 批量删除记录API
///
/// API文档: https://open.feishu.cn/document/server-docs/docs/bitable-v1/app/table/record/batchDelete
...
impl BatchDeleteRecordRequest {
    ...
    pub async fn execute(self) -> SDKResult<BatchDeleteRecordResponse> {
        ...
        let api_endpoint = BitableApiV1::RecordBatchDelete(self.app_token.clone(), self.table_id.clone());
