//! Bitable 删除记录API
///
/// API文档: https://open.feishu.cn/document/server-docs/docs/bitable-v1/app/table/record/delete
...
impl DeleteRecordRequest {
    ...
    pub async fn execute(self) -> SDKResult<DeleteRecordResponse> {
        ...
        let api_endpoint = BitableApiV1::RecordDelete(self.app_token.clone(), self.table_id.clone(), self.record_id.clone());
