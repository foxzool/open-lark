...
impl DeleteViewRequest {
    pub fn new(config: Config) -> Self {
        Self {
            api_request: ApiRequest::new(config, Method::DELETE, "/open-apis/bitable/v1/apps/{}/tables/{}/views/{}".to_string()),
...
mod tests {
    ...
    #[test]
    fn test_delete_view_request_minimal() {
        let request = DeleteViewRequest::builder()
    ...
    #[test]
    fn test_delete_view_request_builder_chaining() {
        let request = DeleteViewRequest::builder()
            .app_token("app123")
            .table_id("table123")
            .view_id("view123")
    ...
    #[test]
    fn test_delete_view_response_trait() {
        assert_eq!(DeleteViewResponse::data_format(), ResponseFormat::Data);
    }

    #[test]
    fn test_delete_view_response() {
        let view = View {
        ...
        let response = DeleteViewResponse { view };
    ...
    #[test]
    fn test_delete_view_request_different_user_id_types() {
        let open_id_request = DeleteViewRequest::builder()
            .app_token("app-token")
            .table_id("table-id")
            .view_id("view-id")
            .user_id_type("open_id")
        ...
        let user_id_request = DeleteViewRequest::builder()
            .app_token("app-token")
            .table_id("table-id")
            .view_id("view-id")
            .user_id_type("user_id")
        ...
        let union_id_request = DeleteViewRequest::builder()
            .app_token("app-token")
            .table_id("table-id")
            .view_id("view-id")
    ...
    #[test]
    fn test_delete_view_request_empty_strings() {
        let request = DeleteViewRequest::builder()
            .app_token("")
            .table_id("")
            .view_id("")
    ...
    #[test]
    fn test_delete_view_request_long_ids() {
