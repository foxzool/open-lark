...
impl AppTableViewService {
    ...
    pub async fn create_view(&self, request: &CreateViewRequest) -> SDKResult<CreateViewResponse> {
        ...
        log::info!("创建视图: app_token={}, table_id={}, view_name={}, view_type={}",
                  request.app_token, request.table_id, request.view_name, request.view_type);
        ...
        let api_req = ApiRequest {
            ...
            api_path: format!("/open-apis/bitable/v1/apps/{}/tables/{}/views", request.app_token, request.table_id),
        ...
        log::info!("创建视图完成: app_token={}, table_id={}, view_name={}",
                  request.app_token, request.table_id, request.view_name);
    ...
    pub async fn update_view(&self, request: &UpdateViewRequest) -> SDKResult<UpdateViewResponse> {
        ...
        log::info!("更新视图: app_token={}, table_id={}, view_id={}",
        ...
        let api_req = ApiRequest {
            ...
            api_path: format!("/open-apis/bitable/v1/apps/{}/tables/{}/views/{}", request.app_token, request.table_id, request.view_id),
            supported_access_token_types: vec![AccessTokenType::Tenant, AccessTokenType::User],
            body: serde_json::to_vec(&body)?,
            query_params: HashMap::new(),
            ..Default::default()
        ...
        log::info!("更新视图完成: app_token={}, table_id={}, view_id={}",
                  request.app_token, request.table_id, request.view_id);
    ...
    pub async fn delete_view(&self, request: &DeleteViewRequest) -> SDKResult<DeleteViewResponse> {
        ...
        log::info!("删除视图: app_token={}, table_id={}, view_id={}",
                  request.app_token, request.table_id, request.view_id);
        ...
        log::info!("删除视图完成: app_token={}, table_id={}, view_id={}",
                  request.app_token, request.table_id, request.view_id);
    ...
    pub async fn list_views(&self, request: &ListViewsRequest) -> SDKResult<ListViewsResponse> {
        ...
        log::info!("列出视图: app_token={}, table_id={}", request.app_token, request.table_id);
        ...
        log::info!("列出视图完成: app_token={}, table_id={}, count={}",
                  request.app_token,
                  request.table_id,
    ...
    pub async fn get_view(&self, request: &GetViewRequest) -> SDKResult<GetViewResponse> {
        ...
        log::info!("获取视图: app_token={}, table_id={}, view_id={}",
                  request.app_token, request.table_id, request.view_id);
        ...
        log::info!("获取视图完成: app_token={}, table_id={}, view_id={}",
                  request.app_token, request.table_id, request.view_id);
...
impl CreateViewRequestBuilder {
    pub fn new(app_token: impl Into<String>, table_id: impl Into<String>, view_name: impl Into<String>, view_type: impl Into<String>) -> Self {
        Self {
            request: CreateViewRequest {
...
impl UpdateViewRequestBuilder {
    pub fn new(app_token: impl Into<String>, table_id: impl Into<String>, view_id: impl Into<String>) -> Self {
        Self {
            request: UpdateViewRequest {
                app_token: app_token.into(),
                table_id: table_id.into(),
