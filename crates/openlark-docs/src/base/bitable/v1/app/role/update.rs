/// Bitable 更新自定义角色
///
/// docPath: /document/uAjLw4CM/ukTMukTMukTM/reference/bitable-v1/app-role/update
...
impl UpdateAppRoleRequest {
    ...
    pub async fn execute(self) -> SDKResult<UpdateAppRoleResponse> {
        ...
        let api_request: ApiRequest<UpdateAppRoleResponse> =
            ApiRequest::put(&api_endpoint.to_url()).body(serde_json::to_vec(&UpdateAppRoleRequestBody {
