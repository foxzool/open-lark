...
impl AppTableFieldService {
    ...
    /// # 返回
    /// 返回新创建的字段信息
    pub async fn create_field(&self, request: &CreateFieldRequest) -> SDKResult<CreateFieldResponse> {
        // 验证请求参数
        request.validate()
            .map_err(|e| LarkAPIError::illegal_param(format!("请求参数验证失败: {}", e)))?;

        log::info!("新增字段: app_token={}, table_id={}, field_name={}, field_type={}",
                  request.app_token, request.table_id, request.field_name, request.field_type);
        ...
        let api_req = ApiRequest {
            ...
            api_path: format!("/open-apis/bitable/v1/apps/{}/tables/{}/fields", request.app_token, request.table_id),
        ...
        log::info!("新增字段完成: app_token={}, table_id={}, field_name={}",
                  request.app_token, request.table_id, request.field_name);
    ...
    /// # 返回
    /// 返回更新后的字段信息
    pub async fn update_field(&self, request: &UpdateFieldRequest) -> SDKResult<UpdateFieldResponse> {
        // 验证请求参数
        request.validate()
            .map_err(|e| LarkAPIError::illegal_param(format!("请求参数验证失败: {}", e)))?;

        log::info!("更新字段: app_token={}, table_id={}, field_id={}",
        ...
        let api_req = ApiRequest {
            ...
            api_path: format!("/open-apis/bitable/v1/apps/{}/tables/{}/fields/{}", request.app_token, request.table_id, request.field_id),
            supported_access_token_types: vec![AccessTokenType::Tenant, AccessTokenType::User],
            body: serde_json::to_vec(&body)?,
            query_params: HashMap::new(),
            ..Default::default()
        ...
        log::info!("更新字段完成: app_token={}, table_id={}, field_id={}",
                  request.app_token, request.table_id, request.field_id);
    ...
    /// # 返回
    /// 返回删除操作的结果
    pub async fn delete_field(&self, request: &DeleteFieldRequest) -> SDKResult<DeleteFieldResponse> {
        // 验证请求参数
        request.validate()
            .map_err(|e| LarkAPIError::illegal_param(format!("请求参数验证失败: {}", e)))?;

        log::info!("删除字段: app_token={}, table_id={}, field_id={}",
                  request.app_token, request.table_id, request.field_id);
        ...
        log::info!("删除字段完成: app_token={}, table_id={}, field_id={}",
                  request.app_token, request.table_id, request.field_id);
    ...
    pub async fn list_fields(&self, request: &ListFieldsRequest) -> SDKResult<ListFieldsResponse> {
        ...
        log::info!("列出字段: app_token={}, table_id={}", request.app_token, request.table_id);
        ...
        log::info!("列出字段完成: app_token={}, table_id={}, count={}",
                  request.app_token,
                  request.table_id,
...
impl CreateFieldRequestBuilder {
    pub fn new(app_token: impl Into<String>, table_id: impl Into<String>, field_name: impl Into<String>, field_type: impl Into<String>) -> Self {
        Self {
            request: CreateFieldRequest {
...
impl UpdateFieldRequestBuilder {
    pub fn new(app_token: impl Into<String>, table_id: impl Into<String>, field_id: impl Into<String>) -> Self {
        Self {
            request: UpdateFieldRequest {
                app_token: app_token.into(),
                table_id: table_id.into(),
