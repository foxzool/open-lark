...
use crate::v2::custom_field::add::{AddCustomFieldBody, AddCustomFieldResponse};
use openlark_core::{
...
impl AddCustomFieldRequest {
    ...
    pub async fn execute_with_options(
        ...
        let request = ApiRequest::<AddCustomFieldResponse>::post(api_endpoint.to_url())
            .body(serialize_params(&self.body, "将自定义字段加入资源")?);
