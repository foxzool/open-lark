...
/// 批量修改邮件会话请求。
#[derive(Debug, Clone)]
pub struct UserMailboxThreadBatchModifyRequest {
    config: Arc<Config>,
    user_mailbox_id: String,
}

impl UserMailboxThreadBatchModifyRequest {
    /// 创建请求。
    ...
    pub async fn execute_with_options(
        ...
        let path = format!(
            "/open-apis/mail/v1/user_mailboxes/{}/threads/batch_modify",
...
mod tests {
    ...
    fn builder_initializes() {
        ...
        let _request = UserMailboxThreadBatchModifyRequest::new(config);
    }
}
