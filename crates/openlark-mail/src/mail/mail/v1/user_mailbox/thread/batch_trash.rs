...
/// 批量删除邮件会话请求。
#[derive(Debug, Clone)]
pub struct UserMailboxThreadBatchTrashRequest {
    config: Arc<Config>,
    user_mailbox_id: String,
}

impl UserMailboxThreadBatchTrashRequest {
    /// 创建请求。
    ...
    pub async fn execute_with_options(
        ...
        let path = format!(
            "/open-apis/mail/v1/user_mailboxes/{}/threads/batch_trash",
...
mod tests {
    ...
    fn builder_initializes() {
        ...
        let _request = UserMailboxThreadBatchTrashRequest::new(config);
    }
}
