...
/// 修改邮件会话请求。
#[derive(Debug, Clone)]
pub struct UserMailboxThreadModifyRequest {
    config: Arc<Config>,
    user_mailbox_id: String,
    thread_id: String,
}

impl UserMailboxThreadModifyRequest {
    /// 创建请求。
    ...
    pub async fn execute_with_options(
        ...
        let path = format!(
            "/open-apis/mail/v1/user_mailboxes/{}/threads/{}/modify",
...
mod tests {
    ...
    fn builder_initializes() {
        ...
        let _request = UserMailboxThreadModifyRequest::new(config);
    }
}
