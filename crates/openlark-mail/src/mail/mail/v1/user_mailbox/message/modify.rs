...
/// 修改邮件请求。
#[derive(Debug, Clone)]
pub struct UserMailboxMessageModifyRequest {
    config: Arc<Config>,
    user_mailbox_id: String,
    message_id: String,
}

impl UserMailboxMessageModifyRequest {
    /// 创建请求。
    ...
    pub async fn execute_with_options(
        ...
        let path = format!(
            "/open-apis/mail/v1/user_mailboxes/{}/messages/{}/modify",
...
mod tests {
    ...
    fn builder_initializes() {
        ...
        let _request = UserMailboxMessageModifyRequest::new(config);
    }
}
