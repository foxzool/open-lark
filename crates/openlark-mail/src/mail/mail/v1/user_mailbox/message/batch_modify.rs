...
/// 批量修改邮件请求。
#[derive(Debug, Clone)]
pub struct UserMailboxMessageBatchModifyRequest {
    config: Arc<Config>,
    user_mailbox_id: String,
}

impl UserMailboxMessageBatchModifyRequest {
    /// 创建请求。
    ...
    pub async fn execute_with_options(
        ...
        let path = format!(
            "/open-apis/mail/v1/user_mailboxes/{}/messages/batch_modify",
...
mod tests {
    ...
    fn builder_initializes() {
        ...
        let _request = UserMailboxMessageBatchModifyRequest::new(config);
    }
}
