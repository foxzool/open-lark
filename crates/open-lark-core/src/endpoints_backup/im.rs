...
// IM相关的端点常量
pub const IM_V1_MESSAGES: &'static str = "/open-apis/im/v1/messages";
pub const IM_V1_CHATS: &'static str = "/open-apis/im/v1/chats";
pub const IM_V1_BATCH_MESSAGES: &'static str = "/open-apis/im/v1/batch_messages";
pub const IM_V2_MESSAGES: &'static str = "/open-apis/im/v2/messages";

// 为了向后兼容性，提供端点常量别名
pub const SEND_MESSAGE: &'static str = IM_V1_MESSAGES;
pub const CHAT_CREATE: &'static str = IM_V1_CHATS;
