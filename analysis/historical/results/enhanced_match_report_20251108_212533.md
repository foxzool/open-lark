...
| 更新工作表属性 | POST | /open-apis/sheets/v2/spreadsheets/:spreadsheetToken/sheets_batch_update | src/service/sheets/v2/sheet_management.rs:283 | 1.00 |
| 增加行列 | POST | /open-apis/sheets/v2/spreadsheets/:spreadsheetToken/dimension_range | src/service/sheets/v2/dimension_operations.rs:687 | 1.00 |
| 插入行列 | POST | /open-apis/sheets/v2/spreadsheets/:spreadsheetToken/insert_dimension_range | src/service/sheets/v2/dimension_operations.rs:573 | 1.00 |
| 更新行列 | PUT | /open-apis/sheets/v2/spreadsheets/:spreadsheetToken/dimension_range | src/service/sheets/v2/dimension_operations.rs:747 | 1.00 |
| 删除行列 | DELETE | /open-apis/sheets/v2/spreadsheets/:spreadsheetToken/dimension_range | src/service/sheets/v2/dimension_operations.rs:627 | 1.00 |
| 合并单元格 | POST | /open-apis/sheets/v2/spreadsheets/:spreadsheetToken/merge_cells | src/service/sheets/v2/merge_cells.rs:319 | 1.00 |
| 拆分单元格 | POST | /open-apis/sheets/v2/spreadsheets/:spreadsheetToken/unmerge_cells | src/service/sheets/v2/merge_cells.rs:370 | 1.00 |
| 批量设置单元格样式 | PUT | /open-apis/sheets/v2/spreadsheets/:spreadsheetToken/styles_batch_update | src/service/sheets/v2/style_operations.rs:552 | 1.00 |
| 设置下拉列表 | POST | /open-apis/sheets/v2/spreadsheets/:spreadsheetToken/dataValidation | src/service/sheets/v2/data_validation.rs:600 | 1.00 |

## ❌ 未匹配的API

⚠️ 共有 1540 个未匹配的API，只显示前20个
...
- **POST**: /open-apis/sheets/v2/spreadsheets/:spreadsheetToken/metainfo
  - 位置: src/service/sheets/v2/metainfo.rs:298
  - 原因: Not in API list

- **GET**: /open-apis/sheets/v2/spreadsheets/:queryParams/metainfo?:spreadsheetToken
  - 位置: src/service/sheets/v2/metainfo.rs:303
  - 原因: Not in API list

- **POST**: /open-apis/sheets/v2/spreadsheets/:spreadsheetToken/images
  - 位置: src/service/sheets/v2/image_write.rs:1265
  - 原因: Not in API list

- **POST**: /open-apis/sheets/v2/spreadsheets/:parameter/values_batch_get
  - 位置: src/service/sheets/v2/batch_read_ranges.rs:290
  - 原因: Not in API list

- **GET**: /open-apis/sheets/v2/spreadsheets/:parameter/values_batch_get?:parameter
  - 位置: src/service/sheets/v2/batch_read_ranges.rs:293
  - 原因: Not in API list

- **PUT**: /open-apis/sheets/v2/spreadsheets/:sheetId/dataValidation/:spreadsheetToken/:data_validationId
  - 位置: src/service/sheets/v2/data_validation.rs:661
  - 原因: Not in API list

- **POST**: /open-apis/sheets/v3/spreadsheets/:sheetId/sheets/:spreadsheetToken/filter_views
  - 位置: src/service/sheets/v3/filter_views.rs:701
  - 原因: Not in API list

- **GET**: /open-apis/sheets/v3/spreadsheets/:sheetId/sheets/:filter_viewId/filter_views/:spreadsheetToken
  - 位置: src/service/sheets/v3/filter_views.rs:754
  - 原因: Not in API list

- **PATCH**: /open-apis/sheets/v3/spreadsheets/:sheetId/sheets/:filter_viewId/filter_views/:spreadsheetToken
  - 位置: src/service/sheets/v3/filter_views.rs:812
  - 原因: Not in API list

- **DELETE**: /open-apis/sheets/v3/spreadsheets/:sheetId/sheets/:filter_viewId/filter_views/:spreadsheetToken
  - 位置: src/service/sheets/v3/filter_views.rs:865
  - 原因: Not in API list
