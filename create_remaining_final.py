#!/usr/bin/env python3
"""创建 application 和 security 剩余 API"""

import os

# application 剩余 6 个 API
application_apis = [
    ...
    ("application/app_version/contacts_range", "GetAppVersionContactsRange", "get", "/open-apis/application/v6/applications/{}/app_versions/{}/contacts_range", "获取应用版本中开发者申请的通讯录权限范围", "app_id, version_id"),
...
# security 剩余 11 个 API  
security_apis = [
    ("access_record/list", "ListAccessRecords", "get", "/open-apis/acs/v1/access_records", "获取门禁记录列表", ""),
