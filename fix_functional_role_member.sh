...
# 修复 functional_role_member.rs 文件

FILE="/Users/zool/RustroverProjects/open-lark/crates/open-lark-communication/src/contact/v3/functional_role_member.rs"
...
impl FunctionalRoleMemberService {
    ...
    pub async fn create(
        ...
        let api_req = ApiRequest {
            ...
            api_path: EndpointBuilder::replace_param(
                open_lark_core::core::endpoints::contact::CONTACT_V3_FUNCTIONAL_ROLES_MEMBERS,
                "role_id",
                role_id,
            ),
    ...
    pub async fn batch_create(
        ...
        let api_req = ApiRequest {
            http_method: reqwest::Method::POST,
            api_path: EndpointBuilder::replace_param(
                open_lark_core::core::endpoints::contact::CONTACT_V3_FUNCTIONAL_ROLES_MEMBERS_BATCH,
                "role_id",
                role_id,
            ),
            supported_access_token_types: vec![AccessTokenType::Tenant],
    ...
    pub async fn scopes(
        ...
        let api_req = ApiRequest {
            ...
            api_path: EndpointBuilder::replace_param(
                open_lark_core::core::endpoints::contact::CONTACT_V3_FUNCTIONAL_ROLES_MEMBERS_SCOPES,
                "role_id",
                role_id,
            ),
            supported_access_token_types: vec![AccessTokenType::Tenant],
    ...
    pub async fn get(
        ...
        let api_req = ApiRequest {
            ...
            api_path: EndpointBuilder::replace_param(
                open_lark_core::core::endpoints::contact::CONTACT_V3_FUNCTIONAL_ROLES_MEMBERS_GET,
                "role_id",
                role_id,
...
echo "修复完成: functional_role_member.rs"