...
基于 `analysis/data/api_list_export.csv` 分析结果，总共有1,688个API，按bizTag分类统计如下：

| 排名 | bizTag | API数量 | 占比 | 业务重要性 | 主要功能描述 | 所属模块 | 状态 |
|------|--------|---------|------|-----------|-------------|----------|------|
| 1 | **hire** | **182** | **10.8%** | 🔴 **极高** | 招聘管理、Offer管理、候选人跟踪、面试安排 | openlark-hr | 🟡 开发中 |
| 2 | **ccm** | **174** | **10.3%** | 🔴 **极高** | 云文档协同、文档处理、表格、知识库、云盘 | openlark-docs | 🟡 开发中 |
| 3 | **corehr** | **144** | **8.5%** | 🔴 **极高** | 核心HR系统、员工管理、组织架构、基础人事 | openlark-hr | 🟡 开发中 |
| 4 | **feishu_people** | **105** | **6.2%** | 🟡 **高** | 人员信息管理、员工档案、人员资料维护 | openlark-hr | 🟡 开发中 |
| 5 | **contact** | **77** | **4.6%** | 🟡 **高** | 通讯录管理、用户信息、部门管理、联系人 | openlark-communication | ✅ 生产就绪 |
| 6 | **task** | **75** | **4.4%** | 🟡 **高** | 任务管理、任务分配、任务跟踪、项目协作 | openlark-workflow | 🟡 开发中 |
| 7 | **im** | **75** | **4.4%** | 🔴 **极高** | 即时消息、消息发送、群聊管理、消息卡片 | openlark-communication | ✅ 生产就绪 |
| 8 | **mail** | **67** | **4.0%** | 🟢 **中** | 邮件发送、接收、邮件管理、邮件组 | openlark-mail | 🟡 开发中 |
| 9 | **vc** | **56** | **3.3%** | 🟡 **高** | 视频会议、会议室管理、会议控制、屏幕共享 | openlark-meeting | 🟡 开发中 |
| 10 | **approval** | **53** | **3.1%** | 🟡 **高** | 审批流程、审批定义、审批实例、模板管理 | openlark-workflow | 🟡 开发中 |
| 11 | **helpdesk** | **50** | **3.0%** | 🟢 **中** | 客服管理、工单系统、帮助台、客户支持 | openlark-helpdesk | 🟡 开发中 |
| 12 | **base** | **49** | **2.9%** | 🟡 **高** | 多维表格应用、数据表管理、视图、字段操作 | openlark-docs | 🟡 开发中 |
| 13 | **calendar** | **44** | **2.6%** | 🟡 **高** | 日历管理、日程安排、会议创建、时间管理 | openlark-meeting | 🟡 开发中 |
| 14 | **attendance** | **39** | **2.3%** | 🟡 **高** | 考勤记录、请假审批、加班管理、排班 | openlark-hr | ✅ 生产就绪 |
| 15 | **app_engine** | **37** | **2.2%** | 🟢 **中** | 应用引擎、应用管理、多租户、应用市场 | openlark-platform | 🟡 开发中 |
| 16 | **application** | **35** | **2.1%** | 🟢 **中** | 应用管理、应用配置、应用部署、版本控制 | openlark-application | 🟡 开发中 |
| 17 | **baike** | **27** | **1.6%** | 🟢 **中** | 企业知识库、Wiki管理、知识条目、分类 | openlark-docs | 🟡 开发中 |
| 18 | **ai** | **23** | **1.4%** | 🟡 **高** | AI服务、智能分析、AI助手、自然语言处理 | openlark-ai | 🟡 开发中 |
| 19 | **directory** | **21** | **1.2%** | 🟢 **中** | 目录服务、用户搜索、组织目录、人员查找 | openlark-platform | 🟡 开发中 |
| 20 | **compensation_management** | **21** | **1.2%** | 🟢 **中** | 薪酬管理、薪资计算、调薪、薪酬结构 | openlark-hr | 🟡 开发中 |
| 21 | **aily** | **21** | **1.2%** | 🟢 **中** | 爱力友相关服务、社交功能、动态分享 | openlark-communication | 🟡 开发中 |
| 22 | **performance** | **20** | **1.2%** | 🟢 **中** | 绩效管理、考核评估、绩效反馈、目标设定 | openlark-hr | 🟡 开发中 |
| 23 | **meeting_room** | **17** | **1.0%** | 🟢 **中** | 会议室预订、会议室管理、设备管理 | openlark-meeting | 🟡 开发中 |
| 24 | **search** | **14** | **0.8%** | 🟢 **中** | 搜索服务、内容检索、全文搜索、智能搜索 | openlark-analytics | 🟡 开发中 |
| 25 | **admin** | **14** | **0.8%** | 🟢 **中** | 管理功能、系统管理、后台管理、配置 | openlark-platform | 🟡 开发中 |
| 26 | **acs** | **14** | **0.8%** | 🟡 **高** | 访问控制、权限管理、ACL、角色权限 | openlark-security | 🟡 开发中 |
| 27 | **payroll** | **12** | **0.7%** | 🟢 **中** | 薪资计算、薪资发放、工资条、个税处理 | openlark-hr | 🟡 开发中 |
| 28 | **okr** | **12** | **0.7%** | 🟢 **中** | OKR目标管理、绩效跟踪、目标设定、进度管理 | openlark-hr | 🟡 开发中 |
| 29 | **auth** | **11** | **0.7%** | 🔴 **极高** | 身份认证、令牌管理、OAuth、权限验证 | openlark-security | ✅ 生产就绪 |
| 30 | **security_and_compliance** | **8** | **0.5%** | 🟡 **高** | 安全合规、安全审计、风险评估、合规检查 | openlark-security | 🟡 开发中 |
| 31 | **minutes** | **4** | **0.2%** | 🟢 **中** | 会议记录管理、转录服务、会议纪要 | openlark-docs | 🟡 开发中 |
| 32 | **ehr** | **2** | **0.1%** | 🟢 **中** | 电子化人力资源、EHR系统集成 | openlark-hr | 🟡 开发中 |
| 33 | **moments** | **1** | **0.1%** | 🟢 **低** | 企业动态、朋友圈、动态分享 | openlark-communication | 🟡 开发中 |

### 统计汇总

| 分类维度 | 数量 | 详情 |
|----------|------|------|
| **总API数量** | **1,504** | 100% (基于实际统计) |
| **bizTag总数** | **33** | 覆盖所有业务领域 |
| **极高重要性bizTag** | **5** | hire, ccm, corehr, im, auth |
| **高重要性bizTag** | **10** | contact, task, vc, approval, attendance, calendar, ai, acs, security_and_compliance |
| **已实现bizTag** | **4** | contact, im, attendance, auth (生产就绪) |
| **开发中bizTag** | **29** | 其余所有bizTag |
| **未实现bizTag** | **0** | 所有bizTag都有对应的crate模块 |

### 数据一致性说明

根据详细的bizTag统计，实际的API总数为 **1,504个**，与之前提到的1,688个存在184个的差异。可能的原因包括：

1. **数据源更新**: 原始分析数据可能基于不同时间点的API列表
2. **API去重**: 可能存在重复计算或去重处理
3. **版本差异**: 不同API版本的计算方式可能不同
4. **统计范围**: 可能包含/排除了一些内部API或测试API

**建议行动**:
- 以详细的bizTag统计为准（1,504个）
- 重新扫描最新的API数据以确认准确数量
- 更新其他相关文档中的总数引用

### 按业务模块聚合统计

| 目标模块 | bizTag数量 | API总数 | 占比 | 业务重要性 | 当前状态 |
|----------|------------|---------|------|-----------|----------|
| **openlark-hr** | **9** | **536** | **31.7%** | 🔴 **极高** | 🟡 开发中 |
| **openlark-docs** | **4** | **254** | **15.0%** | 🔴 **极高** | 🟡 开发中 |
| **openlark-communication** | **3** | **153** | **9.1%** | 🔴 **极高** | 🟢 生产就绪 |
| **openlark-workflow** | **2** | **128** | **7.6%** | 🟡 **高** | 🟡 开发中 |
| **openlark-meeting** | **3** | **117** | **6.9%** | 🟡 **高** | 🟡 开发中 |
| **openlark-security** | **3** | **33** | **2.0%** | 🟡 **高** | 🟡 开发中 |
| **openlark-platform** | **3** | **72** | **4.3%** | 🟢 **中** | 🟡 开发中 |
| **openlark-mail** | **1** | **67** | **4.0%** | 🟢 **中** | 🟡 开发中 |
| **openlark-helpdesk** | **1** | **50** | **3.0%** | 🟢 **中** | 🟡 开发中 |
| **openlark-ai** | **1** | **23** | **1.4%** | 🟡 **高** | 🟡 开发中 |
| **openlark-application** | **1** | **35** | **2.1%** | 🟢 **中** | 🟡 开发中 |
| **openlark-analytics** | **1** | **14** | **0.8%** | 🟢 **中** | 🟡 开发中 |

### 业务重要性说明

**重要性评级标准**：
- 🔴 **极高**: 核心业务功能，企业必需，使用频率极高
- 🟡 **高**: 重要业务功能，大部分企业需要，使用频率高
- 🟢 **中**: 一般业务功能，特定企业需要，使用频率中等
- 🟢 **低**: 辅助功能，少数企业需要，使用频率较低

**开发状态说明**：
- ✅ **生产就绪**: API已完整实现，可用于生产环境
- 🟡 **开发中**: API正在开发过程中，部分功能可用
- 🔴 **规划中**: API尚未开始开发，处于设计阶段
