...
[获取事件出口 IP](https://open.feishu.cn/document/server-docs/event-subscription-guide/list)
...
[步骤二：添加事件](https://open.feishu.cn/document/server-docs/event-subscription-guide/event-subscription-configure-/subscription-event-case)
[步骤三：接收事件](https://open.feishu.cn/document/server-docs/event-subscription-guide/event-subscription-configure-/encrypt-key-encryption-configuration-case)
