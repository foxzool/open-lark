...
[批量撤回消息](https://open.feishu.cn/document/server-docs/im-v1/batch_message/delete)
[查询批量消息推送和阅读人数](https://open.feishu.cn/document/server-docs/im-v1/batch_message/read_user)
...
## 表情回复
[表情回复概述](https://open.feishu.cn/document/server-docs/im-v1/message-reaction/overview-of-message-reaction-resources)
[表情文案说明](https://open.feishu.cn/document/server-docs/im-v1/message-reaction/emojis-introduce)
[添加消息表情回复](https://open.feishu.cn/document/server-docs/im-v1/message-reaction/create)
[获取消息表情回复](https://open.feishu.cn/document/server-docs/im-v1/message-reaction/list)
[删除消息表情回复](https://open.feishu.cn/document/server-docs/im-v1/message-reaction/delete)
### 事件
[新增消息表情回复](https://open.feishu.cn/document/server-docs/im-v1/message-reaction/event/created)
[删除消息表情回复](https://open.feishu.cn/document/server-docs/im-v1/message-reaction/event/deleted)

## Pin
[Pin 消息概述](https://open.feishu.cn/document/im-v1/pin/pin-overview)
[Pin 消息](https://open.feishu.cn/document/server-docs/im-v1/pin/create)
[移除 Pin 消息](https://open.feishu.cn/document/server-docs/im-v1/pin/delete)
[获取群内 Pin 消息](https://open.feishu.cn/document/server-docs/im-v1/pin/list)
...
[发送仅特定人可见的消息卡片](https://open.feishu.cn/document/server-docs/im-v1/message-card/send-message-cards-that-are-only-visible-to-certain-people)
[删除仅特定人可见的消息卡片](https://open.feishu.cn/document/server-docs/im-v1/message-card/delete-message-cards-that-are-only-visible-to-certain-people)

## URL 预览
[更新 URL 预览](https://open.feishu.cn/document/im-v1/url_preview/batch_update)